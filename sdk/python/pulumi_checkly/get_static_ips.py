...
def get_static_ips(ip_family: Optional[builtins.str] = None,
    ...
    :param builtins.str ip_family: Specify the IP families you want to get static IPs for. Only `IPv6` or `IPv4` are valid options.
    :param Sequence[builtins.str] locations: Specify the locations you want to get static IPs for.
    """
    __args__ = dict()
...
def get_static_ips_output(ip_family: Optional[pulumi.Input[Optional[builtins.str]]] = None,
