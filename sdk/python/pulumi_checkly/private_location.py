...
class PrivateLocationArgs:
    def __init__(__self__, *,
                 slug_name: pulumi.Input[builtins.str],
                 icon: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a PrivateLocation resource.
        :param pulumi.Input[builtins.str] slug_name: Valid slug name.
        :param pulumi.Input[builtins.str] icon: Icon assigned to the private location.
        :param pulumi.Input[builtins.str] name: The private location name.
        """
    ...
    def slug_name(self) -> pulumi.Input[builtins.str]:
        """
        Valid slug name.
        """
    ...
    @slug_name.setter
    def slug_name(self, value: pulumi.Input[builtins.str]):
...
class _PrivateLocationState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 slug_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering PrivateLocation resources.
        :param pulumi.Input[builtins.str] icon: Icon assigned to the private location.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] keys: Private location API keys.
        :param pulumi.Input[builtins.str] name: The private location name.
        :param pulumi.Input[builtins.str] slug_name: Valid slug name.
        """
        if icon is not None:
    ...
    @property
    @pulumi.getter(name="slugName")
    def slug_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Valid slug name.
        """
        return pulumi.get(self, "slug_name")
    ...
    @slug_name.setter
    def slug_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "slug_name", value)
...
class PrivateLocation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            slug_name: Optional[pulumi.Input[builtins.str]] = None) -> 'PrivateLocation':
        """
    ...
    @property
    @pulumi.getter
    def keys(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Private location API keys.
        """
        return pulumi.get(self, "keys")
    ...
    @property
    @pulumi.getter(name="slugName")
    def slug_name(self) -> pulumi.Output[builtins.str]:
        """
        Valid slug name.
        """
        return pulumi.get(self, "slug_name")
