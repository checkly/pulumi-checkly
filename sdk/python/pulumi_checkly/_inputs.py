...
@pulumi.input_type
class HeartbeatAlertChannelSubscriptionArgs:
    def __init__(__self__, *,
                 activated: pulumi.Input[bool],
                 channel_id: pulumi.Input[int]):
        pulumi.set(__self__, "activated", activated)
...
@pulumi.input_type
class HeartbeatAlertSettingsArgs:
    def __init__(__self__, *,
                 escalation_type: Optional[pulumi.Input[str]] = None,
                 parallel_run_failure_thresholds: Optional[pulumi.Input[Sequence[pulumi.Input['HeartbeatAlertSettingsParallelRunFailureThresholdArgs']]]] = None,
                 reminders: Optional[pulumi.Input[Sequence[pulumi.Input['HeartbeatAlertSettingsReminderArgs']]]] = None,
                 run_based_escalations: Optional[pulumi.Input[Sequence[pulumi.Input['HeartbeatAlertSettingsRunBasedEscalationArgs']]]] = None,
                 ssl_certificates: Optional[pulumi.Input[Sequence[pulumi.Input['HeartbeatAlertSettingsSslCertificateArgs']]]] = None,
                 time_based_escalations: Optional[pulumi.Input[Sequence[pulumi.Input['HeartbeatAlertSettingsTimeBasedEscalationArgs']]]] = None):
        """
        :param pulumi.Input[str] escalation_type: Determines what type of escalation to use. Possible values are `RUN_BASED` or `TIME_BASED`.
        """
        if escalation_type is not None:
    ...
    @property
    @pulumi.getter(name="parallelRunFailureThresholds")
    def parallel_run_failure_thresholds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['HeartbeatAlertSettingsParallelRunFailureThresholdArgs']]]]:
        return pulumi.get(self, "parallel_run_failure_thresholds")

    @parallel_run_failure_thresholds.setter
    def parallel_run_failure_thresholds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['HeartbeatAlertSettingsParallelRunFailureThresholdArgs']]]]):
        pulumi.set(self, "parallel_run_failure_thresholds", value)

    @property
    @pulumi.getter
    def reminders(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['HeartbeatAlertSettingsReminderArgs']]]]:
        return pulumi.get(self, "reminders")

    @reminders.setter
    def reminders(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['HeartbeatAlertSettingsReminderArgs']]]]):
        pulumi.set(self, "reminders", value)

    @property
    @pulumi.getter(name="runBasedEscalations")
    def run_based_escalations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['HeartbeatAlertSettingsRunBasedEscalationArgs']]]]:
        return pulumi.get(self, "run_based_escalations")

    @run_based_escalations.setter
    def run_based_escalations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['HeartbeatAlertSettingsRunBasedEscalationArgs']]]]):
        pulumi.set(self, "run_based_escalations", value)

    @property
    @pulumi.getter(name="sslCertificates")
    def ssl_certificates(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['HeartbeatAlertSettingsSslCertificateArgs']]]]:
        warnings.warn("""This property is deprecated and it's ignored by the Checkly Public API. It will be removed in a future version.""", DeprecationWarning)
        pulumi.log.warn("""ssl_certificates is deprecated: This property is deprecated and it's ignored by the Checkly Public API. It will be removed in a future version.""")
    ...
    @ssl_certificates.setter
    def ssl_certificates(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['HeartbeatAlertSettingsSslCertificateArgs']]]]):
        pulumi.set(self, "ssl_certificates", value)

    @property
    @pulumi.getter(name="timeBasedEscalations")
    def time_based_escalations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['HeartbeatAlertSettingsTimeBasedEscalationArgs']]]]:
        return pulumi.get(self, "time_based_escalations")

    @time_based_escalations.setter
    def time_based_escalations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['HeartbeatAlertSettingsTimeBasedEscalationArgs']]]]):
        pulumi.set(self, "time_based_escalations", value)


@pulumi.input_type
class HeartbeatAlertSettingsParallelRunFailureThresholdArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[bool]] = None,
                 percentage: Optional[pulumi.Input[int]] = None):
        """
...
@pulumi.input_type
class HeartbeatAlertSettingsReminderArgs:
    def __init__(__self__, *,
                 amount: Optional[pulumi.Input[int]] = None,
                 interval: Optional[pulumi.Input[int]] = None):
        """
...
@pulumi.input_type
class HeartbeatAlertSettingsRunBasedEscalationArgs:
    def __init__(__self__, *,
                 failed_run_threshold: Optional[pulumi.Input[int]] = None):
        """
        :param pulumi.Input[int] failed_run_threshold: After how many failed consecutive check runs an alert notification should be sent. Possible values are between 1 and 5. (Default `1`).
...
@pulumi.input_type
class HeartbeatAlertSettingsSslCertificateArgs:
    def __init__(__self__, *,
                 alert_threshold: Optional[pulumi.Input[int]] = None,
                 enabled: Optional[pulumi.Input[bool]] = None):
        """
...
@pulumi.input_type
class HeartbeatAlertSettingsTimeBasedEscalationArgs:
    def __init__(__self__, *,
                 minutes_failing_threshold: Optional[pulumi.Input[int]] = None):
        """
        :param pulumi.Input[int] minutes_failing_threshold: After how many minutes after a check starts failing an alert should be sent. Possible values are `5`, `10`, `15`, and `30`. (Default `5`).
