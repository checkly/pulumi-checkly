...
class DashboardArgs:
    def __init__(__self__, *,
                 custom_url: pulumi.Input[builtins.str],
                 checks_per_page: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 hide_tags: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 paginate: Optional[pulumi.Input[builtins.bool]] = None,
                 pagination_rate: Optional[pulumi.Input[builtins.int]] = None,
                 refresh_rate: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 use_tags_and_operator: Optional[pulumi.Input[builtins.bool]] = None,
                 width: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Dashboard resource.
        :param pulumi.Input[builtins.str] custom_url: A subdomain name under 'checklyhq.com'. Needs to be unique across all users.
        :param pulumi.Input[builtins.int] checks_per_page: Determines how many checks to show per page.
        :param pulumi.Input[builtins.str] custom_domain: A custom user domain, e.g. 'status.example.com'. See the docs on updating your DNS and SSL usage.
        :param pulumi.Input[builtins.str] description: HTML \\n\\n description for the dashboard.
        :param pulumi.Input[builtins.str] favicon: A URL pointing to an image file to use as browser favicon.
        :param pulumi.Input[builtins.str] header: A piece of text displayed at the top of your dashboard.
        :param pulumi.Input[builtins.bool] hide_tags: Show or hide the tags on the dashboard.
        :param pulumi.Input[builtins.bool] is_private: Set your dashboard as private and generate key.
        :param pulumi.Input[builtins.str] link: A link to for the dashboard logo.
        :param pulumi.Input[builtins.str] logo: A URL pointing to an image file to use for the dashboard logo.
        :param pulumi.Input[builtins.bool] paginate: Determines if pagination is on or off.
        :param pulumi.Input[builtins.int] pagination_rate: How often to trigger pagination in seconds. Possible values `30`, `60` and `300`.
        :param pulumi.Input[builtins.int] refresh_rate: How often to refresh the dashboard in seconds. Possible values `60`, '300' and `600`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of one or more tags that filter which checks to display on the dashboard.
        :param pulumi.Input[builtins.bool] use_tags_and_operator: Set when to use AND operator for fetching dashboard tags.
        :param pulumi.Input[builtins.str] width: Determines whether to use the full screen or focus in the center. Possible values `FULL` and `960PX`.
        """
    ...
    def custom_url(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @custom_url.setter
    def custom_url(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "custom_url", value)

    @property
    @pulumi.getter(name="checksPerPage")
    def checks_per_page(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def checks_per_page(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def hide_tags(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @hide_tags.setter
    def hide_tags(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def paginate(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @paginate.setter
    def paginate(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "paginate", value)

    @property
    @pulumi.getter(name="paginationRate")
    def pagination_rate(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def pagination_rate(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def use_tags_and_operator(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_tags_and_operator(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DashboardState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] hide_tags: Show or hide the tags on the dashboard.
        :param pulumi.Input[builtins.bool] is_private: Set your dashboard as private and generate key.
        :param pulumi.Input[builtins.str] key: The access key when the dashboard is private.
        :param pulumi.Input[builtins.str] link: A link to for the dashboard logo.
        :param pulumi.Input[builtins.str] logo: A URL pointing to an image file to use for the dashboard logo.
        :param pulumi.Input[builtins.bool] paginate: Determines if pagination is on or off.
        :param pulumi.Input[builtins.int] pagination_rate: How often to trigger pagination in seconds. Possible values `30`, `60` and `300`.
...
class Dashboard(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            use_tags_and_operator: Optional[pulumi.Input[builtins.bool]] = None,
            width: Optional[pulumi.Input[builtins.str]] = None) -> 'Dashboard':
        """
    ...
    @property
    @pulumi.getter(name="checksPerPage")
    def checks_per_page(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Determines how many checks to show per page.
        """
        return pulumi.get(self, "checks_per_page")
    ...
    @property
    @pulumi.getter(name="customUrl")
    def custom_url(self) -> pulumi.Output[builtins.str]:
        """
        A subdomain name under 'checklyhq.com'. Needs to be unique across all users.
        """
        return pulumi.get(self, "custom_url")
    ...
    @property
    @pulumi.getter
    def header(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A piece of text displayed at the top of your dashboard.
        """
        return pulumi.get(self, "header")
    ...
    @property
    @pulumi.getter(name="hideTags")
    def hide_tags(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Show or hide the tags on the dashboard.
        """
        return pulumi.get(self, "hide_tags")
    ...
    @property
    @pulumi.getter(name="isPrivate")
    def is_private(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set your dashboard as private and generate key.
        """
        return pulumi.get(self, "is_private")
    ...
    @property
    @pulumi.getter
    def paginate(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Determines if pagination is on or off.
        """
        return pulumi.get(self, "paginate")
    ...
    @property
    @pulumi.getter(name="paginationRate")
    def pagination_rate(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        How often to trigger pagination in seconds. Possible values `30`, `60` and `300`.
        """
        return pulumi.get(self, "pagination_rate")
    ...
    @property
    @pulumi.getter(name="useTagsAndOperator")
    def use_tags_and_operator(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set when to use AND operator for fetching dashboard tags.
        """
        return pulumi.get(self, "use_tags_and_operator")
    ...
    @property
    @pulumi.getter
    def width(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Determines whether to use the full screen or focus in the center. Possible values `FULL` and `960PX`.
        """
        return pulumi.get(self, "width")
