...
class TriggerCheckGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] group_id: The id of the group that you want to attach the trigger to.
        :param pulumi.Input[builtins.str] token: The token value created to trigger the group
        :param pulumi.Input[builtins.str] url: The request URL to trigger the group run.
        """
...
class TriggerCheckGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            group_id: Optional[pulumi.Input[builtins.int]] = None,
            token: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'TriggerCheckGroup':
        """
