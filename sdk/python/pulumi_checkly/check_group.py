...
class CheckGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] activated: Determines if the checks in the group are running or not.
        :param pulumi.Input[builtins.int] concurrency: Determines how many checks are run concurrently when triggering a check group from CI/CD or through the API.
        ...
        :param pulumi.Input[builtins.str] local_setup_script: A valid piece of Node.js code to run in the setup phase of an API check in this group.
        :param pulumi.Input[builtins.str] local_teardown_script: A valid piece of Node.js code to run in the teardown phase of an API check in this group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] locations: An array of one or more data center locations where to run the checks.
        :param pulumi.Input[builtins.bool] muted: Determines if any notifications will be sent out when a check in this group fails and/or recovers.
        :param pulumi.Input[builtins.str] name: The name of the check group.
        ...
        :param pulumi.Input[builtins.bool] run_parallel: Determines if the checks in the group should run in all selected locations in parallel or round-robin.
        :param pulumi.Input[builtins.str] runtime_id: The id of the runtime to use for this group.
        :param pulumi.Input[builtins.int] setup_snippet_id: An ID reference to a snippet to use in the setup phase of an API check.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: Tags for organizing and filtering checks.
        ...
        :param pulumi.Input[builtins.bool] use_global_alert_settings: When true, the account level alert settings will be used, not the alert setting defined on this check group.
        """
...
class CheckGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            teardown_snippet_id: Optional[pulumi.Input[builtins.int]] = None,
            use_global_alert_settings: Optional[pulumi.Input[builtins.bool]] = None) -> 'CheckGroup':
        """
