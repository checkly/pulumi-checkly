...
class SnippetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] script: Your Node.js code that interacts with the API check lifecycle, or functions as a partial for browser checks.
        :param pulumi.Input[builtins.str] name: The name of the snippet
        """
...
class Snippet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            script: Optional[pulumi.Input[builtins.str]] = None) -> 'Snippet':
        """
