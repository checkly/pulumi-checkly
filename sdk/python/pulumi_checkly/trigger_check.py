...
class TriggerCheckArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] check_id: The id of the check that you want to attach the trigger to.
        :param pulumi.Input[builtins.str] token: The token value created to trigger the check
        :param pulumi.Input[builtins.str] url: The request URL to trigger the check run.
        """
...
class TriggerCheck(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            check_id: Optional[pulumi.Input[builtins.str]] = None,
            token: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'TriggerCheck':
        """
