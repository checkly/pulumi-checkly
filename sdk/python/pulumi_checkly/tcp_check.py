...
class TcpCheckArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] degraded_response_time: The response time in milliseconds starting from which a check should be considered degraded. Possible values are between 0 and 5000. (Default `4000`).
        :param pulumi.Input[builtins.int] frequency_offset: To create a high frequency check, the property `frequency` must be `0` and `frequency_offset` can be `10`, `20` or `30`.
        ...
        :param pulumi.Input[builtins.int] max_response_time: The response time in milliseconds starting from which a check should be considered failing. Possible values are between 0 and 5000. (Default `5000`).
        ...
        :param pulumi.Input[builtins.bool] should_fail: Allows to invert the behaviour of when a check is considered to fail.
...
class TcpCheck(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            should_fail: Optional[pulumi.Input[builtins.bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            use_global_alert_settings: Optional[pulumi.Input[builtins.bool]] = None) -> 'TcpCheck':
        """
