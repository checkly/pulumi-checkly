...
__all__ = [
    ...
    'CheckRetryStrategy',
    'HeartbeatAlertChannelSubscription',
    'HeartbeatAlertSettings',
    'HeartbeatAlertSettingsParallelRunFailureThreshold',
    'HeartbeatAlertSettingsReminder',
    'HeartbeatAlertSettingsRunBasedEscalation',
    'HeartbeatAlertSettingsSslCertificate',
    'HeartbeatAlertSettingsTimeBasedEscalation',
    'HeartbeatHeartbeat',
]
...
@pulumi.output_type
class HeartbeatAlertChannelSubscription(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "channelId":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in HeartbeatAlertChannelSubscription. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        HeartbeatAlertChannelSubscription.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class HeartbeatAlertSettings(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "escalationType":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in HeartbeatAlertSettings. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        HeartbeatAlertSettings.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 escalation_type: Optional[str] = None,
                 parallel_run_failure_thresholds: Optional[Sequence['outputs.HeartbeatAlertSettingsParallelRunFailureThreshold']] = None,
                 reminders: Optional[Sequence['outputs.HeartbeatAlertSettingsReminder']] = None,
                 run_based_escalations: Optional[Sequence['outputs.HeartbeatAlertSettingsRunBasedEscalation']] = None,
                 ssl_certificates: Optional[Sequence['outputs.HeartbeatAlertSettingsSslCertificate']] = None,
                 time_based_escalations: Optional[Sequence['outputs.HeartbeatAlertSettingsTimeBasedEscalation']] = None):
        """
        :param str escalation_type: Determines what type of escalation to use. Possible values are `RUN_BASED` or `TIME_BASED`.
        """
        if escalation_type is not None:
    ...
    @property
    @pulumi.getter(name="parallelRunFailureThresholds")
    def parallel_run_failure_thresholds(self) -> Optional[Sequence['outputs.HeartbeatAlertSettingsParallelRunFailureThreshold']]:
        return pulumi.get(self, "parallel_run_failure_thresholds")

    @property
    @pulumi.getter
    def reminders(self) -> Optional[Sequence['outputs.HeartbeatAlertSettingsReminder']]:
        return pulumi.get(self, "reminders")

    @property
    @pulumi.getter(name="runBasedEscalations")
    def run_based_escalations(self) -> Optional[Sequence['outputs.HeartbeatAlertSettingsRunBasedEscalation']]:
        return pulumi.get(self, "run_based_escalations")

    @property
    @pulumi.getter(name="sslCertificates")
    def ssl_certificates(self) -> Optional[Sequence['outputs.HeartbeatAlertSettingsSslCertificate']]:
        warnings.warn("""This property is deprecated and it's ignored by the Checkly Public API. It will be removed in a future version.""", DeprecationWarning)
        pulumi.log.warn("""ssl_certificates is deprecated: This property is deprecated and it's ignored by the Checkly Public API. It will be removed in a future version.""")
    ...
    @property
    @pulumi.getter(name="timeBasedEscalations")
    def time_based_escalations(self) -> Optional[Sequence['outputs.HeartbeatAlertSettingsTimeBasedEscalation']]:
        return pulumi.get(self, "time_based_escalations")


@pulumi.output_type
class HeartbeatAlertSettingsParallelRunFailureThreshold(dict):
    def __init__(__self__, *,
                 enabled: Optional[bool] = None,
                 percentage: Optional[int] = None):
        """
...
@pulumi.output_type
class HeartbeatAlertSettingsReminder(dict):
    def __init__(__self__, *,
                 amount: Optional[int] = None,
                 interval: Optional[int] = None):
        """
...
@pulumi.output_type
class HeartbeatAlertSettingsRunBasedEscalation(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "failedRunThreshold":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in HeartbeatAlertSettingsRunBasedEscalation. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        HeartbeatAlertSettingsRunBasedEscalation.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class HeartbeatAlertSettingsSslCertificate(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "alertThreshold":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in HeartbeatAlertSettingsSslCertificate. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        HeartbeatAlertSettingsSslCertificate.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class HeartbeatAlertSettingsTimeBasedEscalation(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "minutesFailingThreshold":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in HeartbeatAlertSettingsTimeBasedEscalation. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        HeartbeatAlertSettingsTimeBasedEscalation.__key_warning(key)
        return super().__getitem__(key)
...
class HeartbeatHeartbeat(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in HeartbeatHeartbeat. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        HeartbeatHeartbeat.__key_warning(key)
        return super().__getitem__(key)
