...
class AlertChannelCall(dict):
    def __init__(__self__, *,
                 ...
                 number: builtins.str):
        """
        :param builtins.str name: The name of this alert channel
        :param builtins.str number: The mobile number to receive the alerts
        """
...
class AlertChannelEmail(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str address: The email address of this email alert channel.
        """
...
class AlertChannelSlack(dict):
    def __init__(__self__, *,
                 ...
                 url: builtins.str):
        """
        :param builtins.str channel: The name of the alert's Slack channel
        :param builtins.str url: The Slack webhook URL
        """
...
class AlertChannelWebhook(dict):
    ...
    def __init__(__self__, *,
                 ...
                 webhook_secret: Optional[builtins.str] = None,
                 webhook_type: Optional[builtins.str] = None):
        """
        :param builtins.str method: (Default `POST`)
        :param builtins.str webhook_type: Type of the webhook. Possible values are 'WEBHOOK*DISCORD', 'WEBHOOK*FIREHYDRANT', 'WEBHOOK*GITLAB*ALERT', 'WEBHOOK*SPIKESH', 'WEBHOOK*SPLUNK', 'WEBHOOK*MSTEAMS' and 'WEBHOOK*TELEGRAM'.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "url", url)
    ...
    def webhook_secret(self) -> Optional[builtins.str]:
        return pulumi.get(self, "webhook_secret")

    @property
    @pulumi.getter(name="webhookType")
    def webhook_type(self) -> Optional[builtins.str]:
        """
...
class CheckAlertChannelSubscription(dict):
    ...
    def channel_id(self) -> builtins.int:
...
class CheckAlertSettings(dict):
    ...
    def __init__(__self__, *,
                 escalation_type: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str escalation_type: Determines what type of escalation to use. Possible values are `RUN_BASED` or `TIME_BASED`.
        """
    ...
    def escalation_type(self) -> Optional[builtins.str]:
        """
...
class CheckAlertSettingsParallelRunFailureThreshold(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Applicable only for checks scheduled in parallel in multiple locations.
        :param builtins.int percentage: Possible values are `10`, `20`, `30`, `40`, `50`, `60`, `70`, `80`, `100`, and `100`. (Default `10`).
        """
...
class CheckAlertSettingsReminder(dict):
    def __init__(__self__, *,
                 amount: Optional[builtins.int] = None,
                 interval: Optional[builtins.int] = None):
        """
        :param builtins.int amount: How many reminders to send out after the initial alert notification. Possible values are `0`, `1`, `2`, `3`, `4`, `5`, and `100000`
        :param builtins.int interval: Possible values are `5`, `10`, `15`, and `30`. (Default `5`).
        """
    ...
    @property
    @pulumi.getter
    def amount(self) -> Optional[builtins.int]:
        """
...
class CheckAlertSettingsRunBasedEscalation(dict):
    ...
    def __init__(__self__, *,
                 failed_run_threshold: Optional[builtins.int] = None):
        """
        :param builtins.int failed_run_threshold: After how many failed consecutive check runs an alert notification should be sent. Possible values are between 1 and 5. (Default `1`).
        """
    ...
    def failed_run_threshold(self) -> Optional[builtins.int]:
        """
...
class CheckAlertSettingsSslCertificate(dict):
    ...
    def __init__(__self__, *,
                 alert_threshold: Optional[builtins.int] = None,
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.int alert_threshold: How long before SSL certificate expiry to send alerts. Possible values `3`, `7`, `14`, `30`. (Default `3`).
        :param builtins.bool enabled: Determines if alert notifications should be sent for expiring SSL certificates. Possible values `true`, and `false`. (Default `false`).
        """
    ...
    def alert_threshold(self) -> Optional[builtins.int]:
        """
...
class CheckAlertSettingsTimeBasedEscalation(dict):
    ...
    def __init__(__self__, *,
                 minutes_failing_threshold: Optional[builtins.int] = None):
        """
        :param builtins.int minutes_failing_threshold: After how many minutes after a check starts failing an alert should be sent. Possible values are `5`, `10`, `15`, and `30`. (Default `5`).
        """
    ...
    def minutes_failing_threshold(self) -> Optional[builtins.int]:
        """
...
class CheckGroupAlertSettingsSslCertificate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.int alert_threshold: At what moment in time to start alerting on SSL certificates. Possible values `3`, `7`, `14`, `30`. (Default `3`).
        :param builtins.bool enabled: Determines if alert notifications should be sent for expiring SSL certificates.
        """
        if alert_threshold is not None:
            pulumi.set(__self__, "alert_threshold", alert_threshold)
        if enabled is not None:
...
class CheckGroupApiCheckDefaults(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str url: The base url for this group which you can reference with the `GROUP_BASE_URL` variable in all group checks.
        """
...
class CheckGroupApiCheckDefaultsAssertion(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str comparison: The type of comparison to be executed between expected and actual value of the assertion. Possible values `EQUALS`, `NOT_EQUALS`, `HAS_KEY`, `NOT_HAS_KEY`, `HAS_VALUE`, `NOT_HAS_VALUE`, `IS_EMPTY`, `NOT_EMPTY`, `GREATER_THAN`, `LESS_THAN`, `CONTAINS`, `NOT_CONTAINS`, `IS_NULL`, and `NOT_NULL`.
        :param builtins.str source: The source of the asserted value. Possible values `STATUS_CODE`, `JSON_BODY`, `HEADERS`, `TEXT_BODY`, and `RESPONSE_TIME`.
        """
...
class CheckGroupRetryStrategy(dict):
    ...
    def __init__(__self__, *,
                 type: builtins.str,
                 base_backoff_seconds: Optional[builtins.int] = None,
                 max_duration_seconds: Optional[builtins.int] = None,
                 max_retries: Optional[builtins.int] = None,
                 same_region: Optional[builtins.bool] = None):
        """
        :param builtins.str type: Determines which type of retry strategy to use. Possible values are `FIXED`, `LINEAR`, or `EXPONENTIAL`.
        :param builtins.int base_backoff_seconds: The number of seconds to wait before the first retry attempt.
        :param builtins.int max_duration_seconds: The total amount of time to continue retrying the check (maximum 600 seconds).
        :param builtins.int max_retries: The maximum number of times to retry the check. Value must be between 1 and 10.
        :param builtins.bool same_region: Whether retries should be run in the same region as the initial check run.
        """
    ...
    def base_backoff_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def same_region(self) -> Optional[builtins.bool]:
        """
...
class CheckRequest(dict):
    ...
    def __init__(__self__, *,
                 ...
                 method: Optional[builtins.str] = None,
                 query_parameters: Optional[Mapping[str, builtins.str]] = None,
                 skip_ssl: Optional[builtins.bool] = None):
        """
        ...
        :param builtins.str body: The body of the request.
        :param builtins.str body_type: The `Content-Type` header of the request. Possible values `NONE`, `JSON`, `FORM`, `RAW`, and `GRAPHQL`.
        :param builtins.str ip_family: IP Family to be used when executing the api check. The value can be either IPv4 or IPv6.
        :param builtins.str method: The HTTP method to use for this API check. Possible values are `GET`, `POST`, `PUT`, `HEAD`, `DELETE`, `PATCH`. (Default `GET`).
        """
        pulumi.set(__self__, "url", url)
        if assertions is not None:
            pulumi.set(__self__, "assertions", assertions)
    ...
    def body_type(self) -> Optional[builtins.str]:
        """
    ...
    def skip_ssl(self) -> Optional[builtins.bool]:
...
class HeartbeatCheckHeartbeat(dict):
    ...
    def __init__(__self__, *,
                 grace: builtins.int,
                 grace_unit: builtins.str,
                 period: builtins.int,
                 period_unit: builtins.str,
                 ping_token: Optional[builtins.str] = None):
        """
        :param builtins.int grace: How long Checkly should wait before triggering any alerts when a ping does not arrive within the set period.
        :param builtins.str grace_unit: Possible values `seconds`, `minutes`, `hours` and `days`.
        :param builtins.int period: How often you expect a ping to the ping URL.
        :param builtins.str period_unit: Possible values `seconds`, `minutes`, `hours` and `days`.
        :param builtins.str ping_token: Custom token to generate your ping URL. Checkly will expect a ping to `https://ping.checklyhq.com/[PING_TOKEN]`.
        """
    ...
    def grace_unit(self) -> builtins.str:
        """
    ...
    def ping_token(self) -> Optional[builtins.str]:
        """
...
class StatusPageCard(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the card.
...
class TcpCheckRequest(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ip_family: Optional[builtins.str] = None):
        """
        :param builtins.str hostname: The hostname or IP to connect to. Do not include a scheme or a port in this value.
        :param builtins.int port: The port number to connect to.
        :param Sequence['TcpCheckRequestAssertionArgs'] assertions: A request can have multiple assertions.
        :param builtins.str data: The data to send to the target host.
        :param builtins.str ip_family: The IP family to use when executing the TCP check. The value can be either `IPv4` or `IPv6`.
        """
...
class TcpCheckRequestAssertion(dict):
    def __init__(__self__, *,
                 ...
                 target: Optional[builtins.str] = None):
        """
        :param builtins.str comparison: The type of comparison to be executed between expected and actual value of the assertion. Possible values are `EQUALS`, `NOT_EQUALS`, `HAS_KEY`, `NOT_HAS_KEY`, `HAS_VALUE`, `NOT_HAS_VALUE`, `IS_EMPTY`, `NOT_EMPTY`, `GREATER_THAN`, `LESS_THAN`, `CONTAINS`, `NOT_CONTAINS`, `IS_NULL`, and `NOT_NULL`.
        :param builtins.str source: The source of the asserted value. Possible values are `RESPONSE_DATA` and `RESPONSE_TIME`.
        """
        pulumi.set(__self__, "comparison", comparison)
        pulumi.set(__self__, "source", source)
        if property is not None:
