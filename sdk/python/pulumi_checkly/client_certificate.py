...
class ClientCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate: The client certificate in PEM format.
        :param pulumi.Input[builtins.str] host: The host domain that the certificate should be used for.
        :param pulumi.Input[builtins.str] private_key: The private key for the certificate in PEM format.
        :param pulumi.Input[builtins.str] passphrase: Passphrase for the private key.
        :param pulumi.Input[builtins.str] trusted_ca: PEM formatted bundle of CA certificates that the client should trust. The bundle may contain many CA certificates.
        """
...
class ClientCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            passphrase: Optional[pulumi.Input[builtins.str]] = None,
            private_key: Optional[pulumi.Input[builtins.str]] = None,
            trusted_ca: Optional[pulumi.Input[builtins.str]] = None) -> 'ClientCertificate':
        """
    ...
    @property
    @pulumi.getter(name="trustedCa")
    def trusted_ca(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        PEM formatted bundle of CA certificates that the client should trust. The bundle may contain many CA certificates.
        """
        return pulumi.get(self, "trusted_ca")
