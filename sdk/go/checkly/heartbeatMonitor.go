...
// A description of the monitor.
func (o HeartbeatMonitorOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *HeartbeatMonitor) pulumi.StringPtrOutput { return v.Description }).(pulumi.StringPtrOutput)
}
