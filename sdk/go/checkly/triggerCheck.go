...
// The id of the check that you want to attach the trigger to.
func (o TriggerCheckOutput) CheckId() pulumi.StringOutput {
	return o.ApplyT(func(v *TriggerCheck) pulumi.StringOutput { return v.CheckId }).(pulumi.StringOutput)
}

// The token value created to trigger the check
func (o TriggerCheckOutput) Token() pulumi.StringOutput {
	return o.ApplyT(func(v *TriggerCheck) pulumi.StringOutput { return v.Token }).(pulumi.StringOutput)
}

// The request URL to trigger the check run.
func (o TriggerCheckOutput) Url() pulumi.StringOutput {
	return o.ApplyT(func(v *TriggerCheck) pulumi.StringOutput { return v.Url }).(pulumi.StringOutput)
}
