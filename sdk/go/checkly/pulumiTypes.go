...
type HeartbeatAlertChannelSubscription struct {
	Activated bool `pulumi:"activated"`
	ChannelId int  `pulumi:"channelId"`
}

// HeartbeatAlertChannelSubscriptionInput is an input type that accepts HeartbeatAlertChannelSubscriptionArgs and HeartbeatAlertChannelSubscriptionOutput values.
// You can construct a concrete instance of `HeartbeatAlertChannelSubscriptionInput` via:
//
//	HeartbeatAlertChannelSubscriptionArgs{...}
type HeartbeatAlertChannelSubscriptionInput interface {
	pulumi.Input

	ToHeartbeatAlertChannelSubscriptionOutput() HeartbeatAlertChannelSubscriptionOutput
	ToHeartbeatAlertChannelSubscriptionOutputWithContext(context.Context) HeartbeatAlertChannelSubscriptionOutput
}

type HeartbeatAlertChannelSubscriptionArgs struct {
	Activated pulumi.BoolInput `pulumi:"activated"`
	ChannelId pulumi.IntInput  `pulumi:"channelId"`
}

func (HeartbeatAlertChannelSubscriptionArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatAlertChannelSubscription)(nil)).Elem()
}

func (i HeartbeatAlertChannelSubscriptionArgs) ToHeartbeatAlertChannelSubscriptionOutput() HeartbeatAlertChannelSubscriptionOutput {
	return i.ToHeartbeatAlertChannelSubscriptionOutputWithContext(context.Background())
}

func (i HeartbeatAlertChannelSubscriptionArgs) ToHeartbeatAlertChannelSubscriptionOutputWithContext(ctx context.Context) HeartbeatAlertChannelSubscriptionOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatAlertChannelSubscriptionOutput)
}

// HeartbeatAlertChannelSubscriptionArrayInput is an input type that accepts HeartbeatAlertChannelSubscriptionArray and HeartbeatAlertChannelSubscriptionArrayOutput values.
// You can construct a concrete instance of `HeartbeatAlertChannelSubscriptionArrayInput` via:
//
//	HeartbeatAlertChannelSubscriptionArray{ HeartbeatAlertChannelSubscriptionArgs{...} }
type HeartbeatAlertChannelSubscriptionArrayInput interface {
	pulumi.Input

	ToHeartbeatAlertChannelSubscriptionArrayOutput() HeartbeatAlertChannelSubscriptionArrayOutput
	ToHeartbeatAlertChannelSubscriptionArrayOutputWithContext(context.Context) HeartbeatAlertChannelSubscriptionArrayOutput
}

type HeartbeatAlertChannelSubscriptionArray []HeartbeatAlertChannelSubscriptionInput

func (HeartbeatAlertChannelSubscriptionArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]HeartbeatAlertChannelSubscription)(nil)).Elem()
}

func (i HeartbeatAlertChannelSubscriptionArray) ToHeartbeatAlertChannelSubscriptionArrayOutput() HeartbeatAlertChannelSubscriptionArrayOutput {
	return i.ToHeartbeatAlertChannelSubscriptionArrayOutputWithContext(context.Background())
}

func (i HeartbeatAlertChannelSubscriptionArray) ToHeartbeatAlertChannelSubscriptionArrayOutputWithContext(ctx context.Context) HeartbeatAlertChannelSubscriptionArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatAlertChannelSubscriptionArrayOutput)
}

type HeartbeatAlertChannelSubscriptionOutput struct{ *pulumi.OutputState }

func (HeartbeatAlertChannelSubscriptionOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatAlertChannelSubscription)(nil)).Elem()
}

func (o HeartbeatAlertChannelSubscriptionOutput) ToHeartbeatAlertChannelSubscriptionOutput() HeartbeatAlertChannelSubscriptionOutput {
	return o
}

func (o HeartbeatAlertChannelSubscriptionOutput) ToHeartbeatAlertChannelSubscriptionOutputWithContext(ctx context.Context) HeartbeatAlertChannelSubscriptionOutput {
	return o
}

func (o HeartbeatAlertChannelSubscriptionOutput) Activated() pulumi.BoolOutput {
	return o.ApplyT(func(v HeartbeatAlertChannelSubscription) bool { return v.Activated }).(pulumi.BoolOutput)
}

func (o HeartbeatAlertChannelSubscriptionOutput) ChannelId() pulumi.IntOutput {
	return o.ApplyT(func(v HeartbeatAlertChannelSubscription) int { return v.ChannelId }).(pulumi.IntOutput)
}

type HeartbeatAlertChannelSubscriptionArrayOutput struct{ *pulumi.OutputState }

func (HeartbeatAlertChannelSubscriptionArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]HeartbeatAlertChannelSubscription)(nil)).Elem()
}

func (o HeartbeatAlertChannelSubscriptionArrayOutput) ToHeartbeatAlertChannelSubscriptionArrayOutput() HeartbeatAlertChannelSubscriptionArrayOutput {
	return o
}

func (o HeartbeatAlertChannelSubscriptionArrayOutput) ToHeartbeatAlertChannelSubscriptionArrayOutputWithContext(ctx context.Context) HeartbeatAlertChannelSubscriptionArrayOutput {
	return o
}

func (o HeartbeatAlertChannelSubscriptionArrayOutput) Index(i pulumi.IntInput) HeartbeatAlertChannelSubscriptionOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) HeartbeatAlertChannelSubscription {
		return vs[0].([]HeartbeatAlertChannelSubscription)[vs[1].(int)]
	}).(HeartbeatAlertChannelSubscriptionOutput)
}

type HeartbeatAlertSettings struct {
	// Determines what type of escalation to use. Possible values are `RUN_BASED` or `TIME_BASED`.
	EscalationType               *string                                             `pulumi:"escalationType"`
	ParallelRunFailureThresholds []HeartbeatAlertSettingsParallelRunFailureThreshold `pulumi:"parallelRunFailureThresholds"`
	Reminders                    []HeartbeatAlertSettingsReminder                    `pulumi:"reminders"`
	RunBasedEscalations          []HeartbeatAlertSettingsRunBasedEscalation          `pulumi:"runBasedEscalations"`
	// Deprecated: This property is deprecated and it's ignored by the Checkly Public API. It will be removed in a future version.
	SslCertificates      []HeartbeatAlertSettingsSslCertificate      `pulumi:"sslCertificates"`
	TimeBasedEscalations []HeartbeatAlertSettingsTimeBasedEscalation `pulumi:"timeBasedEscalations"`
}

// HeartbeatAlertSettingsInput is an input type that accepts HeartbeatAlertSettingsArgs and HeartbeatAlertSettingsOutput values.
// You can construct a concrete instance of `HeartbeatAlertSettingsInput` via:
//
//	HeartbeatAlertSettingsArgs{...}
type HeartbeatAlertSettingsInput interface {
	pulumi.Input

	ToHeartbeatAlertSettingsOutput() HeartbeatAlertSettingsOutput
	ToHeartbeatAlertSettingsOutputWithContext(context.Context) HeartbeatAlertSettingsOutput
}

type HeartbeatAlertSettingsArgs struct {
	// Determines what type of escalation to use. Possible values are `RUN_BASED` or `TIME_BASED`.
	EscalationType               pulumi.StringPtrInput                                       `pulumi:"escalationType"`
	ParallelRunFailureThresholds HeartbeatAlertSettingsParallelRunFailureThresholdArrayInput `pulumi:"parallelRunFailureThresholds"`
	Reminders                    HeartbeatAlertSettingsReminderArrayInput                    `pulumi:"reminders"`
	RunBasedEscalations          HeartbeatAlertSettingsRunBasedEscalationArrayInput          `pulumi:"runBasedEscalations"`
	// Deprecated: This property is deprecated and it's ignored by the Checkly Public API. It will be removed in a future version.
	SslCertificates      HeartbeatAlertSettingsSslCertificateArrayInput      `pulumi:"sslCertificates"`
	TimeBasedEscalations HeartbeatAlertSettingsTimeBasedEscalationArrayInput `pulumi:"timeBasedEscalations"`
}

func (HeartbeatAlertSettingsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatAlertSettings)(nil)).Elem()
}

func (i HeartbeatAlertSettingsArgs) ToHeartbeatAlertSettingsOutput() HeartbeatAlertSettingsOutput {
	return i.ToHeartbeatAlertSettingsOutputWithContext(context.Background())
}

func (i HeartbeatAlertSettingsArgs) ToHeartbeatAlertSettingsOutputWithContext(ctx context.Context) HeartbeatAlertSettingsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatAlertSettingsOutput)
}

func (i HeartbeatAlertSettingsArgs) ToHeartbeatAlertSettingsPtrOutput() HeartbeatAlertSettingsPtrOutput {
	return i.ToHeartbeatAlertSettingsPtrOutputWithContext(context.Background())
}

func (i HeartbeatAlertSettingsArgs) ToHeartbeatAlertSettingsPtrOutputWithContext(ctx context.Context) HeartbeatAlertSettingsPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatAlertSettingsOutput).ToHeartbeatAlertSettingsPtrOutputWithContext(ctx)
}

// HeartbeatAlertSettingsPtrInput is an input type that accepts HeartbeatAlertSettingsArgs, HeartbeatAlertSettingsPtr and HeartbeatAlertSettingsPtrOutput values.
// You can construct a concrete instance of `HeartbeatAlertSettingsPtrInput` via:
//
//	        HeartbeatAlertSettingsArgs{...}
//
//	or:
//
//	        nil
type HeartbeatAlertSettingsPtrInput interface {
	pulumi.Input

	ToHeartbeatAlertSettingsPtrOutput() HeartbeatAlertSettingsPtrOutput
	ToHeartbeatAlertSettingsPtrOutputWithContext(context.Context) HeartbeatAlertSettingsPtrOutput
}

type heartbeatAlertSettingsPtrType HeartbeatAlertSettingsArgs

func HeartbeatAlertSettingsPtr(v *HeartbeatAlertSettingsArgs) HeartbeatAlertSettingsPtrInput {
	return (*heartbeatAlertSettingsPtrType)(v)
}

func (*heartbeatAlertSettingsPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**HeartbeatAlertSettings)(nil)).Elem()
}

func (i *heartbeatAlertSettingsPtrType) ToHeartbeatAlertSettingsPtrOutput() HeartbeatAlertSettingsPtrOutput {
	return i.ToHeartbeatAlertSettingsPtrOutputWithContext(context.Background())
}

func (i *heartbeatAlertSettingsPtrType) ToHeartbeatAlertSettingsPtrOutputWithContext(ctx context.Context) HeartbeatAlertSettingsPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatAlertSettingsPtrOutput)
}

type HeartbeatAlertSettingsOutput struct{ *pulumi.OutputState }

func (HeartbeatAlertSettingsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatAlertSettings)(nil)).Elem()
}

func (o HeartbeatAlertSettingsOutput) ToHeartbeatAlertSettingsOutput() HeartbeatAlertSettingsOutput {
	return o
}

func (o HeartbeatAlertSettingsOutput) ToHeartbeatAlertSettingsOutputWithContext(ctx context.Context) HeartbeatAlertSettingsOutput {
	return o
}

func (o HeartbeatAlertSettingsOutput) ToHeartbeatAlertSettingsPtrOutput() HeartbeatAlertSettingsPtrOutput {
	return o.ToHeartbeatAlertSettingsPtrOutputWithContext(context.Background())
}

func (o HeartbeatAlertSettingsOutput) ToHeartbeatAlertSettingsPtrOutputWithContext(ctx context.Context) HeartbeatAlertSettingsPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v HeartbeatAlertSettings) *HeartbeatAlertSettings {
		return &v
	}).(HeartbeatAlertSettingsPtrOutput)
}

// Determines what type of escalation to use. Possible values are `RUN_BASED` or `TIME_BASED`.
func (o HeartbeatAlertSettingsOutput) EscalationType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v HeartbeatAlertSettings) *string { return v.EscalationType }).(pulumi.StringPtrOutput)
}

func (o HeartbeatAlertSettingsOutput) ParallelRunFailureThresholds() HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput {
	return o.ApplyT(func(v HeartbeatAlertSettings) []HeartbeatAlertSettingsParallelRunFailureThreshold {
		return v.ParallelRunFailureThresholds
	}).(HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput)
}

func (o HeartbeatAlertSettingsOutput) Reminders() HeartbeatAlertSettingsReminderArrayOutput {
	return o.ApplyT(func(v HeartbeatAlertSettings) []HeartbeatAlertSettingsReminder { return v.Reminders }).(HeartbeatAlertSettingsReminderArrayOutput)
}

func (o HeartbeatAlertSettingsOutput) RunBasedEscalations() HeartbeatAlertSettingsRunBasedEscalationArrayOutput {
	return o.ApplyT(func(v HeartbeatAlertSettings) []HeartbeatAlertSettingsRunBasedEscalation {
		return v.RunBasedEscalations
	}).(HeartbeatAlertSettingsRunBasedEscalationArrayOutput)
}

// Deprecated: This property is deprecated and it's ignored by the Checkly Public API. It will be removed in a future version.
func (o HeartbeatAlertSettingsOutput) SslCertificates() HeartbeatAlertSettingsSslCertificateArrayOutput {
	return o.ApplyT(func(v HeartbeatAlertSettings) []HeartbeatAlertSettingsSslCertificate { return v.SslCertificates }).(HeartbeatAlertSettingsSslCertificateArrayOutput)
}

func (o HeartbeatAlertSettingsOutput) TimeBasedEscalations() HeartbeatAlertSettingsTimeBasedEscalationArrayOutput {
	return o.ApplyT(func(v HeartbeatAlertSettings) []HeartbeatAlertSettingsTimeBasedEscalation {
		return v.TimeBasedEscalations
	}).(HeartbeatAlertSettingsTimeBasedEscalationArrayOutput)
}

type HeartbeatAlertSettingsPtrOutput struct{ *pulumi.OutputState }

func (HeartbeatAlertSettingsPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**HeartbeatAlertSettings)(nil)).Elem()
}

func (o HeartbeatAlertSettingsPtrOutput) ToHeartbeatAlertSettingsPtrOutput() HeartbeatAlertSettingsPtrOutput {
	return o
}

func (o HeartbeatAlertSettingsPtrOutput) ToHeartbeatAlertSettingsPtrOutputWithContext(ctx context.Context) HeartbeatAlertSettingsPtrOutput {
	return o
}

func (o HeartbeatAlertSettingsPtrOutput) Elem() HeartbeatAlertSettingsOutput {
	return o.ApplyT(func(v *HeartbeatAlertSettings) HeartbeatAlertSettings {
		if v != nil {
			return *v
		}
		var ret HeartbeatAlertSettings
		return ret
	}).(HeartbeatAlertSettingsOutput)
}

// Determines what type of escalation to use. Possible values are `RUN_BASED` or `TIME_BASED`.
func (o HeartbeatAlertSettingsPtrOutput) EscalationType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *HeartbeatAlertSettings) *string {
		if v == nil {
			return nil
		}
		return v.EscalationType
...
func (o HeartbeatAlertSettingsPtrOutput) ParallelRunFailureThresholds() HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput {
	return o.ApplyT(func(v *HeartbeatAlertSettings) []HeartbeatAlertSettingsParallelRunFailureThreshold {
		if v == nil {
			return nil
		}
...
func (o HeartbeatAlertSettingsPtrOutput) Reminders() HeartbeatAlertSettingsReminderArrayOutput {
	return o.ApplyT(func(v *HeartbeatAlertSettings) []HeartbeatAlertSettingsReminder {
		if v == nil {
			return nil
		}
		return v.Reminders
	}).(HeartbeatAlertSettingsReminderArrayOutput)
}

func (o HeartbeatAlertSettingsPtrOutput) RunBasedEscalations() HeartbeatAlertSettingsRunBasedEscalationArrayOutput {
	return o.ApplyT(func(v *HeartbeatAlertSettings) []HeartbeatAlertSettingsRunBasedEscalation {
		if v == nil {
			return nil
		}
...
// Deprecated: This property is deprecated and it's ignored by the Checkly Public API. It will be removed in a future version.
func (o HeartbeatAlertSettingsPtrOutput) SslCertificates() HeartbeatAlertSettingsSslCertificateArrayOutput {
	return o.ApplyT(func(v *HeartbeatAlertSettings) []HeartbeatAlertSettingsSslCertificate {
		if v == nil {
			return nil
		}
		return v.SslCertificates
	}).(HeartbeatAlertSettingsSslCertificateArrayOutput)
}

func (o HeartbeatAlertSettingsPtrOutput) TimeBasedEscalations() HeartbeatAlertSettingsTimeBasedEscalationArrayOutput {
	return o.ApplyT(func(v *HeartbeatAlertSettings) []HeartbeatAlertSettingsTimeBasedEscalation {
		if v == nil {
			return nil
		}
...
type HeartbeatAlertSettingsParallelRunFailureThreshold struct {
	// Applicable only for checks scheduled in parallel in multiple locations.
	Enabled *bool `pulumi:"enabled"`
	// Possible values are `10`, `20`, `30`, `40`, `50`, `60`, `70`, `80`, `100`, and `100`. (Default `10`).
	Percentage *int `pulumi:"percentage"`
...
// HeartbeatAlertSettingsParallelRunFailureThresholdInput is an input type that accepts HeartbeatAlertSettingsParallelRunFailureThresholdArgs and HeartbeatAlertSettingsParallelRunFailureThresholdOutput values.
// You can construct a concrete instance of `HeartbeatAlertSettingsParallelRunFailureThresholdInput` via:
//
//	HeartbeatAlertSettingsParallelRunFailureThresholdArgs{...}
type HeartbeatAlertSettingsParallelRunFailureThresholdInput interface {
	pulumi.Input

	ToHeartbeatAlertSettingsParallelRunFailureThresholdOutput() HeartbeatAlertSettingsParallelRunFailureThresholdOutput
	ToHeartbeatAlertSettingsParallelRunFailureThresholdOutputWithContext(context.Context) HeartbeatAlertSettingsParallelRunFailureThresholdOutput
}

type HeartbeatAlertSettingsParallelRunFailureThresholdArgs struct {
	// Applicable only for checks scheduled in parallel in multiple locations.
	Enabled pulumi.BoolPtrInput `pulumi:"enabled"`
	// Possible values are `10`, `20`, `30`, `40`, `50`, `60`, `70`, `80`, `100`, and `100`. (Default `10`).
	Percentage pulumi.IntPtrInput `pulumi:"percentage"`
...
func (HeartbeatAlertSettingsParallelRunFailureThresholdArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatAlertSettingsParallelRunFailureThreshold)(nil)).Elem()
}

func (i HeartbeatAlertSettingsParallelRunFailureThresholdArgs) ToHeartbeatAlertSettingsParallelRunFailureThresholdOutput() HeartbeatAlertSettingsParallelRunFailureThresholdOutput {
	return i.ToHeartbeatAlertSettingsParallelRunFailureThresholdOutputWithContext(context.Background())
}

func (i HeartbeatAlertSettingsParallelRunFailureThresholdArgs) ToHeartbeatAlertSettingsParallelRunFailureThresholdOutputWithContext(ctx context.Context) HeartbeatAlertSettingsParallelRunFailureThresholdOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatAlertSettingsParallelRunFailureThresholdOutput)
}

// HeartbeatAlertSettingsParallelRunFailureThresholdArrayInput is an input type that accepts HeartbeatAlertSettingsParallelRunFailureThresholdArray and HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput values.
// You can construct a concrete instance of `HeartbeatAlertSettingsParallelRunFailureThresholdArrayInput` via:
//
//	HeartbeatAlertSettingsParallelRunFailureThresholdArray{ HeartbeatAlertSettingsParallelRunFailureThresholdArgs{...} }
type HeartbeatAlertSettingsParallelRunFailureThresholdArrayInput interface {
	pulumi.Input

	ToHeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput() HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput
	ToHeartbeatAlertSettingsParallelRunFailureThresholdArrayOutputWithContext(context.Context) HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput
}

type HeartbeatAlertSettingsParallelRunFailureThresholdArray []HeartbeatAlertSettingsParallelRunFailureThresholdInput

func (HeartbeatAlertSettingsParallelRunFailureThresholdArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]HeartbeatAlertSettingsParallelRunFailureThreshold)(nil)).Elem()
}

func (i HeartbeatAlertSettingsParallelRunFailureThresholdArray) ToHeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput() HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput {
	return i.ToHeartbeatAlertSettingsParallelRunFailureThresholdArrayOutputWithContext(context.Background())
}

func (i HeartbeatAlertSettingsParallelRunFailureThresholdArray) ToHeartbeatAlertSettingsParallelRunFailureThresholdArrayOutputWithContext(ctx context.Context) HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput)
}

type HeartbeatAlertSettingsParallelRunFailureThresholdOutput struct{ *pulumi.OutputState }

func (HeartbeatAlertSettingsParallelRunFailureThresholdOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatAlertSettingsParallelRunFailureThreshold)(nil)).Elem()
}

func (o HeartbeatAlertSettingsParallelRunFailureThresholdOutput) ToHeartbeatAlertSettingsParallelRunFailureThresholdOutput() HeartbeatAlertSettingsParallelRunFailureThresholdOutput {
	return o
}

func (o HeartbeatAlertSettingsParallelRunFailureThresholdOutput) ToHeartbeatAlertSettingsParallelRunFailureThresholdOutputWithContext(ctx context.Context) HeartbeatAlertSettingsParallelRunFailureThresholdOutput {
	return o
}

// Applicable only for checks scheduled in parallel in multiple locations.
func (o HeartbeatAlertSettingsParallelRunFailureThresholdOutput) Enabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v HeartbeatAlertSettingsParallelRunFailureThreshold) *bool { return v.Enabled }).(pulumi.BoolPtrOutput)
}

// Possible values are `10`, `20`, `30`, `40`, `50`, `60`, `70`, `80`, `100`, and `100`. (Default `10`).
func (o HeartbeatAlertSettingsParallelRunFailureThresholdOutput) Percentage() pulumi.IntPtrOutput {
	return o.ApplyT(func(v HeartbeatAlertSettingsParallelRunFailureThreshold) *int { return v.Percentage }).(pulumi.IntPtrOutput)
}

type HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput struct{ *pulumi.OutputState }

func (HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]HeartbeatAlertSettingsParallelRunFailureThreshold)(nil)).Elem()
}

func (o HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput) ToHeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput() HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput {
	return o
}

func (o HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput) ToHeartbeatAlertSettingsParallelRunFailureThresholdArrayOutputWithContext(ctx context.Context) HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput {
	return o
}

func (o HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput) Index(i pulumi.IntInput) HeartbeatAlertSettingsParallelRunFailureThresholdOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) HeartbeatAlertSettingsParallelRunFailureThreshold {
		return vs[0].([]HeartbeatAlertSettingsParallelRunFailureThreshold)[vs[1].(int)]
	}).(HeartbeatAlertSettingsParallelRunFailureThresholdOutput)
}

type HeartbeatAlertSettingsReminder struct {
	// How many reminders to send out after the initial alert notification. Possible values are `0`, `1`, `2`, `3`, `4`, `5`, and `100000`
	Amount *int `pulumi:"amount"`
	// Possible values are `5`, `10`, `15`, and `30`. (Default `5`).
	Interval *int `pulumi:"interval"`
...
// HeartbeatAlertSettingsReminderInput is an input type that accepts HeartbeatAlertSettingsReminderArgs and HeartbeatAlertSettingsReminderOutput values.
// You can construct a concrete instance of `HeartbeatAlertSettingsReminderInput` via:
//
//	HeartbeatAlertSettingsReminderArgs{...}
type HeartbeatAlertSettingsReminderInput interface {
	pulumi.Input

	ToHeartbeatAlertSettingsReminderOutput() HeartbeatAlertSettingsReminderOutput
	ToHeartbeatAlertSettingsReminderOutputWithContext(context.Context) HeartbeatAlertSettingsReminderOutput
}

type HeartbeatAlertSettingsReminderArgs struct {
	// How many reminders to send out after the initial alert notification. Possible values are `0`, `1`, `2`, `3`, `4`, `5`, and `100000`
	Amount pulumi.IntPtrInput `pulumi:"amount"`
	// Possible values are `5`, `10`, `15`, and `30`. (Default `5`).
	Interval pulumi.IntPtrInput `pulumi:"interval"`
...
func (HeartbeatAlertSettingsReminderArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatAlertSettingsReminder)(nil)).Elem()
}

func (i HeartbeatAlertSettingsReminderArgs) ToHeartbeatAlertSettingsReminderOutput() HeartbeatAlertSettingsReminderOutput {
	return i.ToHeartbeatAlertSettingsReminderOutputWithContext(context.Background())
}

func (i HeartbeatAlertSettingsReminderArgs) ToHeartbeatAlertSettingsReminderOutputWithContext(ctx context.Context) HeartbeatAlertSettingsReminderOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatAlertSettingsReminderOutput)
}

// HeartbeatAlertSettingsReminderArrayInput is an input type that accepts HeartbeatAlertSettingsReminderArray and HeartbeatAlertSettingsReminderArrayOutput values.
// You can construct a concrete instance of `HeartbeatAlertSettingsReminderArrayInput` via:
//
//	HeartbeatAlertSettingsReminderArray{ HeartbeatAlertSettingsReminderArgs{...} }
type HeartbeatAlertSettingsReminderArrayInput interface {
	pulumi.Input

	ToHeartbeatAlertSettingsReminderArrayOutput() HeartbeatAlertSettingsReminderArrayOutput
	ToHeartbeatAlertSettingsReminderArrayOutputWithContext(context.Context) HeartbeatAlertSettingsReminderArrayOutput
}

type HeartbeatAlertSettingsReminderArray []HeartbeatAlertSettingsReminderInput

func (HeartbeatAlertSettingsReminderArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]HeartbeatAlertSettingsReminder)(nil)).Elem()
}

func (i HeartbeatAlertSettingsReminderArray) ToHeartbeatAlertSettingsReminderArrayOutput() HeartbeatAlertSettingsReminderArrayOutput {
	return i.ToHeartbeatAlertSettingsReminderArrayOutputWithContext(context.Background())
}

func (i HeartbeatAlertSettingsReminderArray) ToHeartbeatAlertSettingsReminderArrayOutputWithContext(ctx context.Context) HeartbeatAlertSettingsReminderArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatAlertSettingsReminderArrayOutput)
}

type HeartbeatAlertSettingsReminderOutput struct{ *pulumi.OutputState }

func (HeartbeatAlertSettingsReminderOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatAlertSettingsReminder)(nil)).Elem()
}

func (o HeartbeatAlertSettingsReminderOutput) ToHeartbeatAlertSettingsReminderOutput() HeartbeatAlertSettingsReminderOutput {
	return o
}

func (o HeartbeatAlertSettingsReminderOutput) ToHeartbeatAlertSettingsReminderOutputWithContext(ctx context.Context) HeartbeatAlertSettingsReminderOutput {
	return o
}

// How many reminders to send out after the initial alert notification. Possible values are `0`, `1`, `2`, `3`, `4`, `5`, and `100000`
func (o HeartbeatAlertSettingsReminderOutput) Amount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v HeartbeatAlertSettingsReminder) *int { return v.Amount }).(pulumi.IntPtrOutput)
}

// Possible values are `5`, `10`, `15`, and `30`. (Default `5`).
func (o HeartbeatAlertSettingsReminderOutput) Interval() pulumi.IntPtrOutput {
	return o.ApplyT(func(v HeartbeatAlertSettingsReminder) *int { return v.Interval }).(pulumi.IntPtrOutput)
}

type HeartbeatAlertSettingsReminderArrayOutput struct{ *pulumi.OutputState }

func (HeartbeatAlertSettingsReminderArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]HeartbeatAlertSettingsReminder)(nil)).Elem()
}

func (o HeartbeatAlertSettingsReminderArrayOutput) ToHeartbeatAlertSettingsReminderArrayOutput() HeartbeatAlertSettingsReminderArrayOutput {
	return o
}

func (o HeartbeatAlertSettingsReminderArrayOutput) ToHeartbeatAlertSettingsReminderArrayOutputWithContext(ctx context.Context) HeartbeatAlertSettingsReminderArrayOutput {
	return o
}

func (o HeartbeatAlertSettingsReminderArrayOutput) Index(i pulumi.IntInput) HeartbeatAlertSettingsReminderOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) HeartbeatAlertSettingsReminder {
		return vs[0].([]HeartbeatAlertSettingsReminder)[vs[1].(int)]
	}).(HeartbeatAlertSettingsReminderOutput)
}

type HeartbeatAlertSettingsRunBasedEscalation struct {
	// After how many failed consecutive check runs an alert notification should be sent. Possible values are between 1 and 5. (Default `1`).
	FailedRunThreshold *int `pulumi:"failedRunThreshold"`
}

// HeartbeatAlertSettingsRunBasedEscalationInput is an input type that accepts HeartbeatAlertSettingsRunBasedEscalationArgs and HeartbeatAlertSettingsRunBasedEscalationOutput values.
// You can construct a concrete instance of `HeartbeatAlertSettingsRunBasedEscalationInput` via:
//
//	HeartbeatAlertSettingsRunBasedEscalationArgs{...}
type HeartbeatAlertSettingsRunBasedEscalationInput interface {
	pulumi.Input

	ToHeartbeatAlertSettingsRunBasedEscalationOutput() HeartbeatAlertSettingsRunBasedEscalationOutput
	ToHeartbeatAlertSettingsRunBasedEscalationOutputWithContext(context.Context) HeartbeatAlertSettingsRunBasedEscalationOutput
}

type HeartbeatAlertSettingsRunBasedEscalationArgs struct {
	// After how many failed consecutive check runs an alert notification should be sent. Possible values are between 1 and 5. (Default `1`).
	FailedRunThreshold pulumi.IntPtrInput `pulumi:"failedRunThreshold"`
}

func (HeartbeatAlertSettingsRunBasedEscalationArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatAlertSettingsRunBasedEscalation)(nil)).Elem()
}

func (i HeartbeatAlertSettingsRunBasedEscalationArgs) ToHeartbeatAlertSettingsRunBasedEscalationOutput() HeartbeatAlertSettingsRunBasedEscalationOutput {
	return i.ToHeartbeatAlertSettingsRunBasedEscalationOutputWithContext(context.Background())
}

func (i HeartbeatAlertSettingsRunBasedEscalationArgs) ToHeartbeatAlertSettingsRunBasedEscalationOutputWithContext(ctx context.Context) HeartbeatAlertSettingsRunBasedEscalationOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatAlertSettingsRunBasedEscalationOutput)
}

// HeartbeatAlertSettingsRunBasedEscalationArrayInput is an input type that accepts HeartbeatAlertSettingsRunBasedEscalationArray and HeartbeatAlertSettingsRunBasedEscalationArrayOutput values.
// You can construct a concrete instance of `HeartbeatAlertSettingsRunBasedEscalationArrayInput` via:
//
//	HeartbeatAlertSettingsRunBasedEscalationArray{ HeartbeatAlertSettingsRunBasedEscalationArgs{...} }
type HeartbeatAlertSettingsRunBasedEscalationArrayInput interface {
	pulumi.Input

	ToHeartbeatAlertSettingsRunBasedEscalationArrayOutput() HeartbeatAlertSettingsRunBasedEscalationArrayOutput
	ToHeartbeatAlertSettingsRunBasedEscalationArrayOutputWithContext(context.Context) HeartbeatAlertSettingsRunBasedEscalationArrayOutput
}

type HeartbeatAlertSettingsRunBasedEscalationArray []HeartbeatAlertSettingsRunBasedEscalationInput

func (HeartbeatAlertSettingsRunBasedEscalationArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]HeartbeatAlertSettingsRunBasedEscalation)(nil)).Elem()
}

func (i HeartbeatAlertSettingsRunBasedEscalationArray) ToHeartbeatAlertSettingsRunBasedEscalationArrayOutput() HeartbeatAlertSettingsRunBasedEscalationArrayOutput {
	return i.ToHeartbeatAlertSettingsRunBasedEscalationArrayOutputWithContext(context.Background())
}

func (i HeartbeatAlertSettingsRunBasedEscalationArray) ToHeartbeatAlertSettingsRunBasedEscalationArrayOutputWithContext(ctx context.Context) HeartbeatAlertSettingsRunBasedEscalationArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatAlertSettingsRunBasedEscalationArrayOutput)
}

type HeartbeatAlertSettingsRunBasedEscalationOutput struct{ *pulumi.OutputState }

func (HeartbeatAlertSettingsRunBasedEscalationOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatAlertSettingsRunBasedEscalation)(nil)).Elem()
}

func (o HeartbeatAlertSettingsRunBasedEscalationOutput) ToHeartbeatAlertSettingsRunBasedEscalationOutput() HeartbeatAlertSettingsRunBasedEscalationOutput {
	return o
}

func (o HeartbeatAlertSettingsRunBasedEscalationOutput) ToHeartbeatAlertSettingsRunBasedEscalationOutputWithContext(ctx context.Context) HeartbeatAlertSettingsRunBasedEscalationOutput {
	return o
}

// After how many failed consecutive check runs an alert notification should be sent. Possible values are between 1 and 5. (Default `1`).
func (o HeartbeatAlertSettingsRunBasedEscalationOutput) FailedRunThreshold() pulumi.IntPtrOutput {
	return o.ApplyT(func(v HeartbeatAlertSettingsRunBasedEscalation) *int { return v.FailedRunThreshold }).(pulumi.IntPtrOutput)
}

type HeartbeatAlertSettingsRunBasedEscalationArrayOutput struct{ *pulumi.OutputState }

func (HeartbeatAlertSettingsRunBasedEscalationArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]HeartbeatAlertSettingsRunBasedEscalation)(nil)).Elem()
}

func (o HeartbeatAlertSettingsRunBasedEscalationArrayOutput) ToHeartbeatAlertSettingsRunBasedEscalationArrayOutput() HeartbeatAlertSettingsRunBasedEscalationArrayOutput {
	return o
}

func (o HeartbeatAlertSettingsRunBasedEscalationArrayOutput) ToHeartbeatAlertSettingsRunBasedEscalationArrayOutputWithContext(ctx context.Context) HeartbeatAlertSettingsRunBasedEscalationArrayOutput {
	return o
}

func (o HeartbeatAlertSettingsRunBasedEscalationArrayOutput) Index(i pulumi.IntInput) HeartbeatAlertSettingsRunBasedEscalationOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) HeartbeatAlertSettingsRunBasedEscalation {
		return vs[0].([]HeartbeatAlertSettingsRunBasedEscalation)[vs[1].(int)]
	}).(HeartbeatAlertSettingsRunBasedEscalationOutput)
}

type HeartbeatAlertSettingsSslCertificate struct {
	// How long before SSL certificate expiry to send alerts. Possible values `3`, `7`, `14`, `30`. (Default `3`).
	AlertThreshold *int `pulumi:"alertThreshold"`
	// Applicable only for checks scheduled in parallel in multiple locations.
	Enabled *bool `pulumi:"enabled"`
...
// HeartbeatAlertSettingsSslCertificateInput is an input type that accepts HeartbeatAlertSettingsSslCertificateArgs and HeartbeatAlertSettingsSslCertificateOutput values.
// You can construct a concrete instance of `HeartbeatAlertSettingsSslCertificateInput` via:
//
//	HeartbeatAlertSettingsSslCertificateArgs{...}
type HeartbeatAlertSettingsSslCertificateInput interface {
	pulumi.Input

	ToHeartbeatAlertSettingsSslCertificateOutput() HeartbeatAlertSettingsSslCertificateOutput
	ToHeartbeatAlertSettingsSslCertificateOutputWithContext(context.Context) HeartbeatAlertSettingsSslCertificateOutput
}

type HeartbeatAlertSettingsSslCertificateArgs struct {
	// How long before SSL certificate expiry to send alerts. Possible values `3`, `7`, `14`, `30`. (Default `3`).
	AlertThreshold pulumi.IntPtrInput `pulumi:"alertThreshold"`
	// Applicable only for checks scheduled in parallel in multiple locations.
	Enabled pulumi.BoolPtrInput `pulumi:"enabled"`
...
func (HeartbeatAlertSettingsSslCertificateArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatAlertSettingsSslCertificate)(nil)).Elem()
}

func (i HeartbeatAlertSettingsSslCertificateArgs) ToHeartbeatAlertSettingsSslCertificateOutput() HeartbeatAlertSettingsSslCertificateOutput {
	return i.ToHeartbeatAlertSettingsSslCertificateOutputWithContext(context.Background())
}

func (i HeartbeatAlertSettingsSslCertificateArgs) ToHeartbeatAlertSettingsSslCertificateOutputWithContext(ctx context.Context) HeartbeatAlertSettingsSslCertificateOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatAlertSettingsSslCertificateOutput)
}

// HeartbeatAlertSettingsSslCertificateArrayInput is an input type that accepts HeartbeatAlertSettingsSslCertificateArray and HeartbeatAlertSettingsSslCertificateArrayOutput values.
// You can construct a concrete instance of `HeartbeatAlertSettingsSslCertificateArrayInput` via:
//
//	HeartbeatAlertSettingsSslCertificateArray{ HeartbeatAlertSettingsSslCertificateArgs{...} }
type HeartbeatAlertSettingsSslCertificateArrayInput interface {
	pulumi.Input

	ToHeartbeatAlertSettingsSslCertificateArrayOutput() HeartbeatAlertSettingsSslCertificateArrayOutput
	ToHeartbeatAlertSettingsSslCertificateArrayOutputWithContext(context.Context) HeartbeatAlertSettingsSslCertificateArrayOutput
}

type HeartbeatAlertSettingsSslCertificateArray []HeartbeatAlertSettingsSslCertificateInput

func (HeartbeatAlertSettingsSslCertificateArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]HeartbeatAlertSettingsSslCertificate)(nil)).Elem()
}

func (i HeartbeatAlertSettingsSslCertificateArray) ToHeartbeatAlertSettingsSslCertificateArrayOutput() HeartbeatAlertSettingsSslCertificateArrayOutput {
	return i.ToHeartbeatAlertSettingsSslCertificateArrayOutputWithContext(context.Background())
}

func (i HeartbeatAlertSettingsSslCertificateArray) ToHeartbeatAlertSettingsSslCertificateArrayOutputWithContext(ctx context.Context) HeartbeatAlertSettingsSslCertificateArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatAlertSettingsSslCertificateArrayOutput)
}

type HeartbeatAlertSettingsSslCertificateOutput struct{ *pulumi.OutputState }

func (HeartbeatAlertSettingsSslCertificateOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatAlertSettingsSslCertificate)(nil)).Elem()
}

func (o HeartbeatAlertSettingsSslCertificateOutput) ToHeartbeatAlertSettingsSslCertificateOutput() HeartbeatAlertSettingsSslCertificateOutput {
	return o
}

func (o HeartbeatAlertSettingsSslCertificateOutput) ToHeartbeatAlertSettingsSslCertificateOutputWithContext(ctx context.Context) HeartbeatAlertSettingsSslCertificateOutput {
	return o
}

// How long before SSL certificate expiry to send alerts. Possible values `3`, `7`, `14`, `30`. (Default `3`).
func (o HeartbeatAlertSettingsSslCertificateOutput) AlertThreshold() pulumi.IntPtrOutput {
	return o.ApplyT(func(v HeartbeatAlertSettingsSslCertificate) *int { return v.AlertThreshold }).(pulumi.IntPtrOutput)
}

// Applicable only for checks scheduled in parallel in multiple locations.
func (o HeartbeatAlertSettingsSslCertificateOutput) Enabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v HeartbeatAlertSettingsSslCertificate) *bool { return v.Enabled }).(pulumi.BoolPtrOutput)
}

type HeartbeatAlertSettingsSslCertificateArrayOutput struct{ *pulumi.OutputState }

func (HeartbeatAlertSettingsSslCertificateArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]HeartbeatAlertSettingsSslCertificate)(nil)).Elem()
}

func (o HeartbeatAlertSettingsSslCertificateArrayOutput) ToHeartbeatAlertSettingsSslCertificateArrayOutput() HeartbeatAlertSettingsSslCertificateArrayOutput {
	return o
}

func (o HeartbeatAlertSettingsSslCertificateArrayOutput) ToHeartbeatAlertSettingsSslCertificateArrayOutputWithContext(ctx context.Context) HeartbeatAlertSettingsSslCertificateArrayOutput {
	return o
}

func (o HeartbeatAlertSettingsSslCertificateArrayOutput) Index(i pulumi.IntInput) HeartbeatAlertSettingsSslCertificateOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) HeartbeatAlertSettingsSslCertificate {
		return vs[0].([]HeartbeatAlertSettingsSslCertificate)[vs[1].(int)]
	}).(HeartbeatAlertSettingsSslCertificateOutput)
}

type HeartbeatAlertSettingsTimeBasedEscalation struct {
	// After how many minutes after a check starts failing an alert should be sent. Possible values are `5`, `10`, `15`, and `30`. (Default `5`).
	MinutesFailingThreshold *int `pulumi:"minutesFailingThreshold"`
}

// HeartbeatAlertSettingsTimeBasedEscalationInput is an input type that accepts HeartbeatAlertSettingsTimeBasedEscalationArgs and HeartbeatAlertSettingsTimeBasedEscalationOutput values.
// You can construct a concrete instance of `HeartbeatAlertSettingsTimeBasedEscalationInput` via:
//
//	HeartbeatAlertSettingsTimeBasedEscalationArgs{...}
type HeartbeatAlertSettingsTimeBasedEscalationInput interface {
	pulumi.Input

	ToHeartbeatAlertSettingsTimeBasedEscalationOutput() HeartbeatAlertSettingsTimeBasedEscalationOutput
	ToHeartbeatAlertSettingsTimeBasedEscalationOutputWithContext(context.Context) HeartbeatAlertSettingsTimeBasedEscalationOutput
}

type HeartbeatAlertSettingsTimeBasedEscalationArgs struct {
	// After how many minutes after a check starts failing an alert should be sent. Possible values are `5`, `10`, `15`, and `30`. (Default `5`).
	MinutesFailingThreshold pulumi.IntPtrInput `pulumi:"minutesFailingThreshold"`
}

func (HeartbeatAlertSettingsTimeBasedEscalationArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatAlertSettingsTimeBasedEscalation)(nil)).Elem()
}

func (i HeartbeatAlertSettingsTimeBasedEscalationArgs) ToHeartbeatAlertSettingsTimeBasedEscalationOutput() HeartbeatAlertSettingsTimeBasedEscalationOutput {
	return i.ToHeartbeatAlertSettingsTimeBasedEscalationOutputWithContext(context.Background())
}

func (i HeartbeatAlertSettingsTimeBasedEscalationArgs) ToHeartbeatAlertSettingsTimeBasedEscalationOutputWithContext(ctx context.Context) HeartbeatAlertSettingsTimeBasedEscalationOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatAlertSettingsTimeBasedEscalationOutput)
}

// HeartbeatAlertSettingsTimeBasedEscalationArrayInput is an input type that accepts HeartbeatAlertSettingsTimeBasedEscalationArray and HeartbeatAlertSettingsTimeBasedEscalationArrayOutput values.
// You can construct a concrete instance of `HeartbeatAlertSettingsTimeBasedEscalationArrayInput` via:
//
//	HeartbeatAlertSettingsTimeBasedEscalationArray{ HeartbeatAlertSettingsTimeBasedEscalationArgs{...} }
type HeartbeatAlertSettingsTimeBasedEscalationArrayInput interface {
	pulumi.Input

	ToHeartbeatAlertSettingsTimeBasedEscalationArrayOutput() HeartbeatAlertSettingsTimeBasedEscalationArrayOutput
	ToHeartbeatAlertSettingsTimeBasedEscalationArrayOutputWithContext(context.Context) HeartbeatAlertSettingsTimeBasedEscalationArrayOutput
}

type HeartbeatAlertSettingsTimeBasedEscalationArray []HeartbeatAlertSettingsTimeBasedEscalationInput

func (HeartbeatAlertSettingsTimeBasedEscalationArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]HeartbeatAlertSettingsTimeBasedEscalation)(nil)).Elem()
}

func (i HeartbeatAlertSettingsTimeBasedEscalationArray) ToHeartbeatAlertSettingsTimeBasedEscalationArrayOutput() HeartbeatAlertSettingsTimeBasedEscalationArrayOutput {
	return i.ToHeartbeatAlertSettingsTimeBasedEscalationArrayOutputWithContext(context.Background())
}

func (i HeartbeatAlertSettingsTimeBasedEscalationArray) ToHeartbeatAlertSettingsTimeBasedEscalationArrayOutputWithContext(ctx context.Context) HeartbeatAlertSettingsTimeBasedEscalationArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatAlertSettingsTimeBasedEscalationArrayOutput)
}

type HeartbeatAlertSettingsTimeBasedEscalationOutput struct{ *pulumi.OutputState }

func (HeartbeatAlertSettingsTimeBasedEscalationOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatAlertSettingsTimeBasedEscalation)(nil)).Elem()
}

func (o HeartbeatAlertSettingsTimeBasedEscalationOutput) ToHeartbeatAlertSettingsTimeBasedEscalationOutput() HeartbeatAlertSettingsTimeBasedEscalationOutput {
	return o
}

func (o HeartbeatAlertSettingsTimeBasedEscalationOutput) ToHeartbeatAlertSettingsTimeBasedEscalationOutputWithContext(ctx context.Context) HeartbeatAlertSettingsTimeBasedEscalationOutput {
	return o
}

// After how many minutes after a check starts failing an alert should be sent. Possible values are `5`, `10`, `15`, and `30`. (Default `5`).
func (o HeartbeatAlertSettingsTimeBasedEscalationOutput) MinutesFailingThreshold() pulumi.IntPtrOutput {
	return o.ApplyT(func(v HeartbeatAlertSettingsTimeBasedEscalation) *int { return v.MinutesFailingThreshold }).(pulumi.IntPtrOutput)
}

type HeartbeatAlertSettingsTimeBasedEscalationArrayOutput struct{ *pulumi.OutputState }

func (HeartbeatAlertSettingsTimeBasedEscalationArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]HeartbeatAlertSettingsTimeBasedEscalation)(nil)).Elem()
}

func (o HeartbeatAlertSettingsTimeBasedEscalationArrayOutput) ToHeartbeatAlertSettingsTimeBasedEscalationArrayOutput() HeartbeatAlertSettingsTimeBasedEscalationArrayOutput {
	return o
}

func (o HeartbeatAlertSettingsTimeBasedEscalationArrayOutput) ToHeartbeatAlertSettingsTimeBasedEscalationArrayOutputWithContext(ctx context.Context) HeartbeatAlertSettingsTimeBasedEscalationArrayOutput {
	return o
}

func (o HeartbeatAlertSettingsTimeBasedEscalationArrayOutput) Index(i pulumi.IntInput) HeartbeatAlertSettingsTimeBasedEscalationOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) HeartbeatAlertSettingsTimeBasedEscalation {
		return vs[0].([]HeartbeatAlertSettingsTimeBasedEscalation)[vs[1].(int)]
	}).(HeartbeatAlertSettingsTimeBasedEscalationOutput)
}

type HeartbeatHeartbeat struct {
...
// HeartbeatHeartbeatInput is an input type that accepts HeartbeatHeartbeatArgs and HeartbeatHeartbeatOutput values.
// You can construct a concrete instance of `HeartbeatHeartbeatInput` via:
//
//	HeartbeatHeartbeatArgs{...}
type HeartbeatHeartbeatInput interface {
	pulumi.Input

	ToHeartbeatHeartbeatOutput() HeartbeatHeartbeatOutput
	ToHeartbeatHeartbeatOutputWithContext(context.Context) HeartbeatHeartbeatOutput
}

type HeartbeatHeartbeatArgs struct {
	// How long Checkly should wait before triggering any alerts when a ping does not arrive within the set period.
...
func (HeartbeatHeartbeatArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatHeartbeat)(nil)).Elem()
}

func (i HeartbeatHeartbeatArgs) ToHeartbeatHeartbeatOutput() HeartbeatHeartbeatOutput {
	return i.ToHeartbeatHeartbeatOutputWithContext(context.Background())
}

func (i HeartbeatHeartbeatArgs) ToHeartbeatHeartbeatOutputWithContext(ctx context.Context) HeartbeatHeartbeatOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatHeartbeatOutput)
}

func (i HeartbeatHeartbeatArgs) ToHeartbeatHeartbeatPtrOutput() HeartbeatHeartbeatPtrOutput {
	return i.ToHeartbeatHeartbeatPtrOutputWithContext(context.Background())
}

func (i HeartbeatHeartbeatArgs) ToHeartbeatHeartbeatPtrOutputWithContext(ctx context.Context) HeartbeatHeartbeatPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatHeartbeatOutput).ToHeartbeatHeartbeatPtrOutputWithContext(ctx)
}

// HeartbeatHeartbeatPtrInput is an input type that accepts HeartbeatHeartbeatArgs, HeartbeatHeartbeatPtr and HeartbeatHeartbeatPtrOutput values.
// You can construct a concrete instance of `HeartbeatHeartbeatPtrInput` via:
//
//	        HeartbeatHeartbeatArgs{...}
//
//	or:
//
//	        nil
type HeartbeatHeartbeatPtrInput interface {
	pulumi.Input

	ToHeartbeatHeartbeatPtrOutput() HeartbeatHeartbeatPtrOutput
	ToHeartbeatHeartbeatPtrOutputWithContext(context.Context) HeartbeatHeartbeatPtrOutput
}

type heartbeatHeartbeatPtrType HeartbeatHeartbeatArgs

func HeartbeatHeartbeatPtr(v *HeartbeatHeartbeatArgs) HeartbeatHeartbeatPtrInput {
	return (*heartbeatHeartbeatPtrType)(v)
}

func (*heartbeatHeartbeatPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**HeartbeatHeartbeat)(nil)).Elem()
}

func (i *heartbeatHeartbeatPtrType) ToHeartbeatHeartbeatPtrOutput() HeartbeatHeartbeatPtrOutput {
	return i.ToHeartbeatHeartbeatPtrOutputWithContext(context.Background())
}

func (i *heartbeatHeartbeatPtrType) ToHeartbeatHeartbeatPtrOutputWithContext(ctx context.Context) HeartbeatHeartbeatPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(HeartbeatHeartbeatPtrOutput)
}

type HeartbeatHeartbeatOutput struct{ *pulumi.OutputState }

func (HeartbeatHeartbeatOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*HeartbeatHeartbeat)(nil)).Elem()
}

func (o HeartbeatHeartbeatOutput) ToHeartbeatHeartbeatOutput() HeartbeatHeartbeatOutput {
	return o
}

func (o HeartbeatHeartbeatOutput) ToHeartbeatHeartbeatOutputWithContext(ctx context.Context) HeartbeatHeartbeatOutput {
	return o
}

func (o HeartbeatHeartbeatOutput) ToHeartbeatHeartbeatPtrOutput() HeartbeatHeartbeatPtrOutput {
	return o.ToHeartbeatHeartbeatPtrOutputWithContext(context.Background())
}

func (o HeartbeatHeartbeatOutput) ToHeartbeatHeartbeatPtrOutputWithContext(ctx context.Context) HeartbeatHeartbeatPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v HeartbeatHeartbeat) *HeartbeatHeartbeat {
		return &v
	}).(HeartbeatHeartbeatPtrOutput)
}

// How long Checkly should wait before triggering any alerts when a ping does not arrive within the set period.
func (o HeartbeatHeartbeatOutput) Grace() pulumi.IntOutput {
	return o.ApplyT(func(v HeartbeatHeartbeat) int { return v.Grace }).(pulumi.IntOutput)
}

// Possible values `seconds`, `minutes`, `hours` and `days`.
func (o HeartbeatHeartbeatOutput) GraceUnit() pulumi.StringOutput {
	return o.ApplyT(func(v HeartbeatHeartbeat) string { return v.GraceUnit }).(pulumi.StringOutput)
}

// How often you expect a ping to the ping URL.
func (o HeartbeatHeartbeatOutput) Period() pulumi.IntOutput {
	return o.ApplyT(func(v HeartbeatHeartbeat) int { return v.Period }).(pulumi.IntOutput)
}

// Possible values `seconds`, `minutes`, `hours` and `days`.
func (o HeartbeatHeartbeatOutput) PeriodUnit() pulumi.StringOutput {
	return o.ApplyT(func(v HeartbeatHeartbeat) string { return v.PeriodUnit }).(pulumi.StringOutput)
}

// Custom token to generate your ping URL. Checkly will expect a ping to `https://ping.checklyhq.com/[PING_TOKEN]`.
func (o HeartbeatHeartbeatOutput) PingToken() pulumi.StringPtrOutput {
	return o.ApplyT(func(v HeartbeatHeartbeat) *string { return v.PingToken }).(pulumi.StringPtrOutput)
}

type HeartbeatHeartbeatPtrOutput struct{ *pulumi.OutputState }

func (HeartbeatHeartbeatPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**HeartbeatHeartbeat)(nil)).Elem()
}

func (o HeartbeatHeartbeatPtrOutput) ToHeartbeatHeartbeatPtrOutput() HeartbeatHeartbeatPtrOutput {
	return o
}

func (o HeartbeatHeartbeatPtrOutput) ToHeartbeatHeartbeatPtrOutputWithContext(ctx context.Context) HeartbeatHeartbeatPtrOutput {
	return o
}

func (o HeartbeatHeartbeatPtrOutput) Elem() HeartbeatHeartbeatOutput {
	return o.ApplyT(func(v *HeartbeatHeartbeat) HeartbeatHeartbeat {
		if v != nil {
			return *v
		}
		var ret HeartbeatHeartbeat
		return ret
	}).(HeartbeatHeartbeatOutput)
}

// How long Checkly should wait before triggering any alerts when a ping does not arrive within the set period.
func (o HeartbeatHeartbeatPtrOutput) Grace() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *HeartbeatHeartbeat) *int {
		if v == nil {
			return nil
		}
		return &v.Grace
...
// Possible values `seconds`, `minutes`, `hours` and `days`.
func (o HeartbeatHeartbeatPtrOutput) GraceUnit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *HeartbeatHeartbeat) *string {
		if v == nil {
			return nil
		}
		return &v.GraceUnit
...
// How often you expect a ping to the ping URL.
func (o HeartbeatHeartbeatPtrOutput) Period() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *HeartbeatHeartbeat) *int {
		if v == nil {
			return nil
		}
...
// Possible values `seconds`, `minutes`, `hours` and `days`.
func (o HeartbeatHeartbeatPtrOutput) PeriodUnit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *HeartbeatHeartbeat) *string {
		if v == nil {
			return nil
		}
...
// Custom token to generate your ping URL. Checkly will expect a ping to `https://ping.checklyhq.com/[PING_TOKEN]`.
func (o HeartbeatHeartbeatPtrOutput) PingToken() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *HeartbeatHeartbeat) *string {
		if v == nil {
			return nil
		}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatAlertChannelSubscriptionInput)(nil)).Elem(), HeartbeatAlertChannelSubscriptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatAlertChannelSubscriptionArrayInput)(nil)).Elem(), HeartbeatAlertChannelSubscriptionArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatAlertSettingsInput)(nil)).Elem(), HeartbeatAlertSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatAlertSettingsPtrInput)(nil)).Elem(), HeartbeatAlertSettingsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatAlertSettingsParallelRunFailureThresholdInput)(nil)).Elem(), HeartbeatAlertSettingsParallelRunFailureThresholdArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatAlertSettingsParallelRunFailureThresholdArrayInput)(nil)).Elem(), HeartbeatAlertSettingsParallelRunFailureThresholdArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatAlertSettingsReminderInput)(nil)).Elem(), HeartbeatAlertSettingsReminderArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatAlertSettingsReminderArrayInput)(nil)).Elem(), HeartbeatAlertSettingsReminderArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatAlertSettingsRunBasedEscalationInput)(nil)).Elem(), HeartbeatAlertSettingsRunBasedEscalationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatAlertSettingsRunBasedEscalationArrayInput)(nil)).Elem(), HeartbeatAlertSettingsRunBasedEscalationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatAlertSettingsSslCertificateInput)(nil)).Elem(), HeartbeatAlertSettingsSslCertificateArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatAlertSettingsSslCertificateArrayInput)(nil)).Elem(), HeartbeatAlertSettingsSslCertificateArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatAlertSettingsTimeBasedEscalationInput)(nil)).Elem(), HeartbeatAlertSettingsTimeBasedEscalationArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatAlertSettingsTimeBasedEscalationArrayInput)(nil)).Elem(), HeartbeatAlertSettingsTimeBasedEscalationArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatHeartbeatInput)(nil)).Elem(), HeartbeatHeartbeatArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*HeartbeatHeartbeatPtrInput)(nil)).Elem(), HeartbeatHeartbeatArgs{})
	...
	pulumi.RegisterOutputType(HeartbeatAlertChannelSubscriptionOutput{})
	pulumi.RegisterOutputType(HeartbeatAlertChannelSubscriptionArrayOutput{})
	pulumi.RegisterOutputType(HeartbeatAlertSettingsOutput{})
	pulumi.RegisterOutputType(HeartbeatAlertSettingsPtrOutput{})
	pulumi.RegisterOutputType(HeartbeatAlertSettingsParallelRunFailureThresholdOutput{})
	pulumi.RegisterOutputType(HeartbeatAlertSettingsParallelRunFailureThresholdArrayOutput{})
	pulumi.RegisterOutputType(HeartbeatAlertSettingsReminderOutput{})
	pulumi.RegisterOutputType(HeartbeatAlertSettingsReminderArrayOutput{})
	pulumi.RegisterOutputType(HeartbeatAlertSettingsRunBasedEscalationOutput{})
	pulumi.RegisterOutputType(HeartbeatAlertSettingsRunBasedEscalationArrayOutput{})
	pulumi.RegisterOutputType(HeartbeatAlertSettingsSslCertificateOutput{})
	pulumi.RegisterOutputType(HeartbeatAlertSettingsSslCertificateArrayOutput{})
	pulumi.RegisterOutputType(HeartbeatAlertSettingsTimeBasedEscalationOutput{})
	pulumi.RegisterOutputType(HeartbeatAlertSettingsTimeBasedEscalationArrayOutput{})
	pulumi.RegisterOutputType(HeartbeatHeartbeatOutput{})
	pulumi.RegisterOutputType(HeartbeatHeartbeatPtrOutput{})
}
