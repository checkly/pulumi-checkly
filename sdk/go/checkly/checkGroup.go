...
//
// Deprecated: The property `environment_variables` is deprecated and will be removed in a future version. Consider using the new `environment_variable` list.
func (o CheckGroupOutput) EnvironmentVariables() pulumi.MapOutput {
	return o.ApplyT(func(v *CheckGroup) pulumi.MapOutput { return v.EnvironmentVariables }).(pulumi.MapOutput)
}
