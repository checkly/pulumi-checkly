...
export class TcpMonitor extends pulumi.CustomResource {
     ...
     */
    public readonly alertChannelSubscriptions!: pulumi.Output<outputs.TcpMonitorAlertChannelSubscription[] | undefined>;
    public readonly alertSettings!: pulumi.Output<outputs.TcpMonitorAlertSettings>;
    /**
     ...
     */
    public readonly request!: pulumi.Output<outputs.TcpMonitorRequest>;
    /**
     * A strategy for retrying failed check runs.
     */
    public readonly retryStrategy!: pulumi.Output<outputs.TcpMonitorRetryStrategy>;
    /**
     ...
     */
    public readonly triggerIncident!: pulumi.Output<outputs.TcpMonitorTriggerIncident | undefined>;
    /**
