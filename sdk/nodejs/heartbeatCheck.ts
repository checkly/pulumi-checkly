...
export class HeartbeatCheck extends pulumi.CustomResource {
    ...
    public readonly alertChannelSubscriptions!: pulumi.Output<outputs.HeartbeatCheckAlertChannelSubscription[] | undefined>;
    public readonly alertSettings!: pulumi.Output<outputs.HeartbeatCheckAlertSettings>;
    public readonly heartbeat!: pulumi.Output<outputs.HeartbeatCheckHeartbeat>;
    /**
     ...
     */
    public readonly triggerIncident!: pulumi.Output<outputs.HeartbeatCheckTriggerIncident | undefined>;
    /**
