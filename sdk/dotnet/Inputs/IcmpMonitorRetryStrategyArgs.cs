...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class IcmpMonitorRetryStrategyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.IcmpMonitorRetryStrategyOnlyOnArgs>? OnlyOn { get; set; }
        ...
        public IcmpMonitorRetryStrategyArgs()
        {
        }
        public static new IcmpMonitorRetryStrategyArgs Empty => new IcmpMonitorRetryStrategyArgs();
    }
}
