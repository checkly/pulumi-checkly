...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class UrlMonitorRequestArgs : global::Pulumi.ResourceArgs
    {
        [Input("assertions")]
        private InputList<Inputs.UrlMonitorRequestAssertionArgs>? _assertions;

        /// <summary>
        /// Assertions to validate the HTTP response. URL monitors only support status code assertions.
        /// </summary>
        public InputList<Inputs.UrlMonitorRequestAssertionArgs> Assertions
        {
            get => _assertions ?? (_assertions = new InputList<Inputs.UrlMonitorRequestAssertionArgs>());
        ...
        public UrlMonitorRequestArgs()
        {
        }
        public static new UrlMonitorRequestArgs Empty => new UrlMonitorRequestArgs();
    }
}
