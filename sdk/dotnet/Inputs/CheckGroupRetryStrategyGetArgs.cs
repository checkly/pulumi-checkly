...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class CheckGroupRetryStrategyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.CheckGroupRetryStrategyOnlyOnGetArgs>? OnlyOn { get; set; }
        ...
        public CheckGroupRetryStrategyGetArgs()
        {
        }
        public static new CheckGroupRetryStrategyGetArgs Empty => new CheckGroupRetryStrategyGetArgs();
    }
}
