...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class TcpCheckRetryStrategyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.TcpCheckRetryStrategyOnlyOnGetArgs>? OnlyOn { get; set; }
        ...
        public TcpCheckRetryStrategyGetArgs()
        {
        }
        public static new TcpCheckRetryStrategyGetArgs Empty => new TcpCheckRetryStrategyGetArgs();
    }
}
