...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class GrpcMonitorRetryStrategyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.GrpcMonitorRetryStrategyOnlyOnArgs>? OnlyOn { get; set; }
        ...
        public GrpcMonitorRetryStrategyArgs()
        {
        }
        public static new GrpcMonitorRetryStrategyArgs Empty => new GrpcMonitorRetryStrategyArgs();
    }
}
