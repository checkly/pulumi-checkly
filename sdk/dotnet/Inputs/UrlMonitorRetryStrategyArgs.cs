...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class UrlMonitorRetryStrategyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.UrlMonitorRetryStrategyOnlyOnArgs>? OnlyOn { get; set; }
        ...
        public UrlMonitorRetryStrategyArgs()
        {
        }
        public static new UrlMonitorRetryStrategyArgs Empty => new UrlMonitorRetryStrategyArgs();
    }
}
