...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class TracerouteMonitorRetryStrategyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.TracerouteMonitorRetryStrategyOnlyOnArgs>? OnlyOn { get; set; }
        ...
        public TracerouteMonitorRetryStrategyArgs()
        {
        }
        public static new TracerouteMonitorRetryStrategyArgs Empty => new TracerouteMonitorRetryStrategyArgs();
    }
}
