...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class CheckRetryStrategyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.CheckRetryStrategyOnlyOnGetArgs>? OnlyOn { get; set; }
        ...
        public CheckRetryStrategyGetArgs()
        {
        }
        public static new CheckRetryStrategyGetArgs Empty => new CheckRetryStrategyGetArgs();
    }
}
