...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class TcpMonitorRetryStrategyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.TcpMonitorRetryStrategyOnlyOnGetArgs>? OnlyOn { get; set; }
        ...
        public TcpMonitorRetryStrategyGetArgs()
        {
        }
        public static new TcpMonitorRetryStrategyGetArgs Empty => new TcpMonitorRetryStrategyGetArgs();
    }
}
