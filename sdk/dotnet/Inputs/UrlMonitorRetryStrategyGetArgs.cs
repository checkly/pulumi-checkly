...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class UrlMonitorRetryStrategyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.UrlMonitorRetryStrategyOnlyOnGetArgs>? OnlyOn { get; set; }
        ...
        public UrlMonitorRetryStrategyGetArgs()
        {
        }
        public static new UrlMonitorRetryStrategyGetArgs Empty => new UrlMonitorRetryStrategyGetArgs();
    }
}
