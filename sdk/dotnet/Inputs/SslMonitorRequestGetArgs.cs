...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class SslMonitorRequestGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("assertions")]
        private InputList<Inputs.SslMonitorRequestAssertionGetArgs>? _assertions;
        ...
        /// </summary>
        public InputList<Inputs.SslMonitorRequestAssertionGetArgs> Assertions
        {
            get => _assertions ?? (_assertions = new InputList<Inputs.SslMonitorRequestAssertionGetArgs>());
        ...
        public Input<Inputs.SslMonitorRequestClientCertificateGetArgs>? ClientCertificate { get; set; }
        ...
        public Input<Inputs.SslMonitorRequestSecurityBaselineGetArgs>? SecurityBaseline { get; set; }
        ...
        public SslMonitorRequestGetArgs()
        {
        }
        public static new SslMonitorRequestGetArgs Empty => new SslMonitorRequestGetArgs();
    }
}
