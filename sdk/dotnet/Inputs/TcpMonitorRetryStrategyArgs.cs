...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class TcpMonitorRetryStrategyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.TcpMonitorRetryStrategyOnlyOnArgs>? OnlyOn { get; set; }
        ...
        public TcpMonitorRetryStrategyArgs()
        {
        }
        public static new TcpMonitorRetryStrategyArgs Empty => new TcpMonitorRetryStrategyArgs();
    }
}
