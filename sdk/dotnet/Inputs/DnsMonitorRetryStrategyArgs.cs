...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class DnsMonitorRetryStrategyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.DnsMonitorRetryStrategyOnlyOnArgs>? OnlyOn { get; set; }
        ...
        public DnsMonitorRetryStrategyArgs()
        {
        }
        public static new DnsMonitorRetryStrategyArgs Empty => new DnsMonitorRetryStrategyArgs();
    }
}
