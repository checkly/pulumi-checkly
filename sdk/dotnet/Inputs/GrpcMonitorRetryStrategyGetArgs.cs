...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class GrpcMonitorRetryStrategyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.GrpcMonitorRetryStrategyOnlyOnGetArgs>? OnlyOn { get; set; }
        ...
        public GrpcMonitorRetryStrategyGetArgs()
        {
        }
        public static new GrpcMonitorRetryStrategyGetArgs Empty => new GrpcMonitorRetryStrategyGetArgs();
    }
}
