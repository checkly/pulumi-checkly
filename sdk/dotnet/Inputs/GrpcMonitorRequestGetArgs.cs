...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class GrpcMonitorRequestGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("assertions")]
        private InputList<Inputs.GrpcMonitorRequestAssertionGetArgs>? _assertions;
        ...
        /// </summary>
        public InputList<Inputs.GrpcMonitorRequestAssertionGetArgs> Assertions
        {
            get => _assertions ?? (_assertions = new InputList<Inputs.GrpcMonitorRequestAssertionGetArgs>());
        ...
        [Input("metadatas")]
        private InputList<Inputs.GrpcMonitorRequestMetadataGetArgs>? _metadatas;

        /// <summary>
        /// gRPC metadata (request headers) sent with the call.
        /// </summary>
        public InputList<Inputs.GrpcMonitorRequestMetadataGetArgs> Metadatas
        {
            get => _metadatas ?? (_metadatas = new InputList<Inputs.GrpcMonitorRequestMetadataGetArgs>());
        ...
        public GrpcMonitorRequestGetArgs()
        {
        }
        public static new GrpcMonitorRequestGetArgs Empty => new GrpcMonitorRequestGetArgs();
    }
}
