...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class DnsMonitorRetryStrategyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.DnsMonitorRetryStrategyOnlyOnGetArgs>? OnlyOn { get; set; }
        ...
        public DnsMonitorRetryStrategyGetArgs()
        {
        }
        public static new DnsMonitorRetryStrategyGetArgs Empty => new DnsMonitorRetryStrategyGetArgs();
    }
}
