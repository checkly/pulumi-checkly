...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class CheckGroupV2EnforceRetryStrategyRetryStrategyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.CheckGroupV2EnforceRetryStrategyRetryStrategyOnlyOnGetArgs>? OnlyOn { get; set; }
        ...
        public CheckGroupV2EnforceRetryStrategyRetryStrategyGetArgs()
        {
        }
        public static new CheckGroupV2EnforceRetryStrategyRetryStrategyGetArgs Empty => new CheckGroupV2EnforceRetryStrategyRetryStrategyGetArgs();
    }
}
