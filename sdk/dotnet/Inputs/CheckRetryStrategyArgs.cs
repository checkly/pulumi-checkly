...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class CheckRetryStrategyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.CheckRetryStrategyOnlyOnArgs>? OnlyOn { get; set; }
        ...
        public CheckRetryStrategyArgs()
        {
        }
        public static new CheckRetryStrategyArgs Empty => new CheckRetryStrategyArgs();
    }
}
