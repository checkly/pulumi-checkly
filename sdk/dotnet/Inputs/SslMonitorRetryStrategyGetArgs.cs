...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class SslMonitorRetryStrategyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.SslMonitorRetryStrategyOnlyOnGetArgs>? OnlyOn { get; set; }
        ...
        public SslMonitorRetryStrategyGetArgs()
        {
        }
        public static new SslMonitorRetryStrategyGetArgs Empty => new SslMonitorRetryStrategyGetArgs();
    }
}
