...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class SslMonitorRetryStrategyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.SslMonitorRetryStrategyOnlyOnArgs>? OnlyOn { get; set; }
        ...
        public SslMonitorRetryStrategyArgs()
        {
        }
        public static new SslMonitorRetryStrategyArgs Empty => new SslMonitorRetryStrategyArgs();
    }
}
