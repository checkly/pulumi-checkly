...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class TracerouteMonitorRetryStrategyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.TracerouteMonitorRetryStrategyOnlyOnGetArgs>? OnlyOn { get; set; }
        ...
        public TracerouteMonitorRetryStrategyGetArgs()
        {
        }
        public static new TracerouteMonitorRetryStrategyGetArgs Empty => new TracerouteMonitorRetryStrategyGetArgs();
    }
}
