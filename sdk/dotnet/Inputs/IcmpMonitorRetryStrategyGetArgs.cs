...
namespace Pulumi.Checkly.Inputs
{
    ...
    public sealed class IcmpMonitorRetryStrategyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyOn")]
        public Input<Inputs.IcmpMonitorRetryStrategyOnlyOnGetArgs>? OnlyOn { get; set; }
        ...
        public IcmpMonitorRetryStrategyGetArgs()
        {
        }
        public static new IcmpMonitorRetryStrategyGetArgs Empty => new IcmpMonitorRetryStrategyGetArgs();
    }
}
