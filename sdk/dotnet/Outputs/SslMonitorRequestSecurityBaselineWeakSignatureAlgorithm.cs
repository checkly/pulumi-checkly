...
namespace Pulumi.Checkly.Outputs
{
    ...
    [OutputType]
    public sealed class SslMonitorRequestSecurityBaselineWeakSignatureAlgorithm
    {
        /// <summary>
        ...
        [OutputConstructor]
        private SslMonitorRequestSecurityBaselineWeakSignatureAlgorithm(string? severity)
        {
            Severity = severity;
        }
    }
