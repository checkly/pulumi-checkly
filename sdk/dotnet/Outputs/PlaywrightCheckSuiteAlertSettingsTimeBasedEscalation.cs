...
namespace Pulumi.Checkly.Outputs
{
    ...
    [OutputType]
    public sealed class PlaywrightCheckSuiteAlertSettingsTimeBasedEscalation
    {
        /// <summary>
        ...
        [OutputConstructor]
        private PlaywrightCheckSuiteAlertSettingsTimeBasedEscalation(int? minutesFailingThreshold)
        {
