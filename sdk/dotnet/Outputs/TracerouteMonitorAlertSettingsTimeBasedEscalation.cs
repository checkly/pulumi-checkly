...
namespace Pulumi.Checkly.Outputs
{
    ...
    [OutputType]
    public sealed class TracerouteMonitorAlertSettingsTimeBasedEscalation
    {
        /// <summary>
        ...
        [OutputConstructor]
        private TracerouteMonitorAlertSettingsTimeBasedEscalation(int? minutesFailingThreshold)
        {
