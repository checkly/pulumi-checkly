...
namespace Pulumi.Checkly.Outputs
{
    ...
    [OutputType]
    public sealed class SslMonitorRequestSecurityBaselineOcspMustStapleRespected
    {
        /// <summary>
        ...
        [OutputConstructor]
        private SslMonitorRequestSecurityBaselineOcspMustStapleRespected(string? severity)
        {
            Severity = severity;
        }
    }
