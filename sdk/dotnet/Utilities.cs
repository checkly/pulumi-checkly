...
namespace Pulumi.Checkly
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Checkly.version.txt");
    ...
    internal sealed class ChecklyResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ChecklyResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
